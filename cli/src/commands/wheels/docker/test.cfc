...
component extends="../base" {
    ...
    private struct function detectContext() {
        ...
        if (findNoCase("/templates/", cwd)) {
            ...
            // Extract template name (e.g., "base" or "api")
            var relativePath = replaceNoCase(cwd, result.monorepoRoot & "/templates/", "");
        ...
        // Check if we're in an example directory
            ...
            result.isValid = true;
            result.type = "example";
            // Extract example name (e.g., "blog-app" or "authentication")
