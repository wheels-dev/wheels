        ...
        <div class="ui grid">
            <div class="two column row">
                ...
                <div class="twelve wide column right aligned">
                    <a href="#urlFor(route = "wheelstestbox")#" class="ui button basic blue">
                    ...
                    <cfloop array="#formats#" index="_format">
                        ...
                        <a href="#urlFor(route = "wheelstestbox", params = __params)#" class="ui button basic<cfif _format eq "html"> active</cfif>">
                            #_format#
                        </a>
                    </cfloop>
                </div>
