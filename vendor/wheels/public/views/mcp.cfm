...
if (!StructKeyExists(variables, "$mcpLogDeprecationWarning")) {
	variables.$mcpLogDeprecationWarning = function() {
...
if (!StructKeyExists(variables, "$mcpEnforceDevelopmentMode")) {
	variables.$mcpEnforceDevelopmentMode = function() {
...
if (!StructKeyExists(variables, "$mcpEnforceLocalhost")) {
	variables.$mcpEnforceLocalhost = function() {
...
if (!StructKeyExists(variables, "$mcpRejectOptions")) {
	variables.$mcpRejectOptions = function() {
...
if (!StructKeyExists(variables, "$mcpHandleRequest")) {
	variables.$mcpHandleRequest = function() {
