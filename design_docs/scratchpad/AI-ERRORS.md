...
**Symptoms:**
```
Could not find the ColdFusion component or interface wheels.WheelsTest
```

**Cause:** Test not extending wheels.WheelsTest or path issue
...
**Solution:**
```cfscript
// Tests automatically use transactions when extending wheels.WheelsTest
component extends="wheels.WheelsTest" {
...
- Extend wheels.WheelsTest for tests
