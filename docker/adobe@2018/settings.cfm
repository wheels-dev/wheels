<cfscript>
	/*
		...
		See http://docs.wheels.dev/docs/configuration-and-defaults for more info.
	*/
	...
	*/
	set(coreTestDataSourceName="wheelstestdb_mysql");
	set(dataSourceName="wheelstestdb_mysql");
