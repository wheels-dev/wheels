...
* Display the links to all the other pages that the user should be able to go to. This is done using the [paginationLinks()](https://wheels.dev/api/v3.1.0/controller.paginationLinks.html) function or using a lower-level function [pagination()](https://wheels.dev/api/v3.1.0/controller.pagination.html).

This chapter will deal with the first part: getting the paginated data. Please proceed to the chapter called [Displaying Links for Pagination](https://wheels.dev/3.1.0/guides/displaying-views-to-users/displaying-links-for-pagination) if you wish to learn how to output the page links in your view.
...
Don't forget to check the chapter [Displaying Links for Pagination](https://wheels.dev/3.1.0/guides/displaying-views-to-users/displaying-links-for-pagination).
