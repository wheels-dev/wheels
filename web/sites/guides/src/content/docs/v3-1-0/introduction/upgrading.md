...
{% hint style="info" %}
**Upgrading to Wheels 4.0?** See the dedicated [Upgrading to Wheels 4.0](/v3-1-0/introduction/upgrading-to-4.0/) guide — it covers all breaking changes, the Legacy Compatibility Adapter, and recommended migrations.
{% endhint %}
