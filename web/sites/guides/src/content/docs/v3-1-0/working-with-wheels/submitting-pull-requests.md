...
See [Using the Test Environment](/v3-1-0/working-with-wheels/using-the-test-environment/) for more detailed instructions.
...
For more information on using the test environment, see [Using the Test Environment](/v3-1-0/working-with-wheels/using-the-test-environment/).