...
8. If needed, open an issue to have the additions and changes in your revision documented in the [CHANGELOG](/v3-1-0/working-with-wheels/https:/github.com/wheels-dev/wheels/blob/main/CHANGELOG/). You may claim the issue if you'd like to do this, but it's entirely your choice.
...
- [Using the Test Environment](/v3-1-0/working-with-wheels/using-the-test-environment/) - Complete guide to the Docker test environment
- [Submitting Pull Requests](/v3-1-0/working-with-wheels/submitting-pull-requests/) - Step-by-step guide to creating and submitting PRs
