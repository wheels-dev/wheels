...
You can also set values based on what environment you have set. For example, you can have different values for your settings depending on whether you're in `development` mode or `production` mode. See the chapter on [Switching Environments](/v3-1-0/working-with-wheels/switching-environments/) for more details.
...
* [Environment settings](/v3-1-0/working-with-wheels/configuration-and-defaults/#environment-settings)
* [URL rewriting settings](/v3-1-0/working-with-wheels/configuration-and-defaults/#url-rewriting-settings)
* [Data source settings](/v3-1-0/working-with-wheels/configuration-and-defaults/#data-source-settings)
* [Function settings](/v3-1-0/working-with-wheels/configuration-and-defaults/#function-settings)
* [Debugging and error settings](/v3-1-0/working-with-wheels/configuration-and-defaults/#debugging-and-error-settings)
* [Caching settings](/v3-1-0/working-with-wheels/configuration-and-defaults/#caching-settings)
* [ORM settings](/v3-1-0/working-with-wheels/configuration-and-defaults/#orm-settings)
* [Plugin settings](/v3-1-0/working-with-wheels/configuration-and-defaults/#plugin-settings)
* [Media settings](/v3-1-0/working-with-wheels/configuration-and-defaults/#media-settings)
* [Routing settings](/v3-1-0/working-with-wheels/configuration-and-defaults/#routing-settings)
* [View helper settings](/v3-1-0/working-with-wheels/configuration-and-defaults/#view-helper-settings)
* [CSRF protection settings](/v3-1-0/working-with-wheels/configuration-and-defaults/#csrf-protection-settings)
* [Miscellaneous Settings](/v3-1-0/working-with-wheels/configuration-and-defaults/#miscellaneous-settings)
* [Migrator settings](/v3-1-0/working-with-wheels/configuration-and-defaults/#migrator-configuration-settings)
...
For more information, refer to the chapter about [Switching Environments](/v3-1-0/working-with-wheels/switching-environments/).
...
For more information, refer to the chapter on [Caching](/v3-1-0/handling-requests-with-controllers/caching/).
...
See the chapter about [Date, Media, and Text Helpers](/v3-1-0/displaying-views-to-users/date-media-and-text-helpers/) for more information.
...
See the chapters about [Using Routes](https://wheels.dev/3.1.0/guides/handling-requests-with-controllers/routing) and [Obfuscating URLs](/v3-1-0/handling-requests-with-controllers/obfuscating-urls/) for more information about how this all works together.
