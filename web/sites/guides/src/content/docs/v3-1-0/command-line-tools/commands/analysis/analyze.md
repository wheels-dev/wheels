...
- [wheels analyze code](/v3-1-0/command-line-tools/commands/analysis/analyze-code/) - Code quality analysis
- [wheels analyze performance](/v3-1-0/command-line-tools/commands/analysis/analyze-performance/) - Performance analysis
- [wheels test run](/v3-1-0/command-line-tools/commands/test/test-run/) - Run tests