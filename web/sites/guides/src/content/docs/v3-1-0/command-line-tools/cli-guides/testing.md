...
- [wheels test run](/v3-1-0/command-line-tools/commands/test/test-run/) - Test execution command
- [wheels test advanced](/v3-1-0/command-line-tools/commands/test/test-advanced/) - Advanced test options
