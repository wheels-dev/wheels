...
- [wheels dbmigrate create table](/v3-1-0/command-line-tools/commands/database/dbmigrate-create-table/) - Create migrations
- [wheels generate property](/v3-1-0/command-line-tools/commands/generate/property/) - Add properties to existing models
- [wheels generate controller](/v3-1-0/command-line-tools/commands/generate/controller/) - Generate controllers
- [wheels scaffold](/v3-1-0/command-line-tools/commands/generate/scaffold/) - Generate complete CRUD