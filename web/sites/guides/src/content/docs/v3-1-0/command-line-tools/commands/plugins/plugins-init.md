...
- [wheels plugin install](/v3-1-0/command-line-tools/commands/plugins/plugins-install/) - Install plugins from ForgeBox
- [wheels plugin list](/v3-1-0/command-line-tools/commands/plugins/plugins-list/) - List installed plugins
- [wheels reload](/v3-1-0/command-line-tools/commands/core/reload/) - Reload application
- [Developing Plugins](/v3-1-0/plugins/developing-plugins/) - Full plugin development guide
