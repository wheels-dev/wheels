...
### Core Commands
- [`wheels mcp setup`](/v3-1-0/command-line-tools/commands/mcp/mcp-setup/) - Configure MCP integration for AI IDEs
- [`wheels mcp status`](/v3-1-0/command-line-tools/commands/mcp/mcp-status/) - Check current MCP integration status
- [`wheels mcp test`](/v3-1-0/command-line-tools/commands/mcp/mcp-test/) - Test MCP connection and functionality
...
### Guides
- [**MCP Configuration Guide**](/v3-1-0/command-line-tools/commands/mcp/mcp-configuration-guide/) - Configure MCP for Claude Code, Cursor, and VS Code with LuCLI auto-discovered tools
...
See the [MCP Configuration Guide](/v3-1-0/command-line-tools/commands/mcp/mcp-configuration-guide/) for per-IDE setup instructions with both LuCLI stdio and HTTP transport options.
...
- [MCP Configuration Guide](/v3-1-0/command-line-tools/commands/mcp/mcp-configuration-guide/) - Per-IDE setup with LuCLI and HTTP transports
- [Wheels CLI Overview](/v3-1-0/command-line-tools/commands/)
- [Code Generation](/v3-1-0/command-line-tools/commands/generate/app/)