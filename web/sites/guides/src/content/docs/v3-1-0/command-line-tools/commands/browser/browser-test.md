...
- [`wheels browser:install`](/v3-1-0/command-line-tools/commands/browser/browser-install/) — Install Playwright
- [Browser Testing Guide](/v3-1-0/command-line-tools/working-with-wheels/browser-testing/) — Full browser testing guide
