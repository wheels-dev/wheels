...
- [`wheels test`](/v3-1-0/command-line-tools/commands/test/test-run/) - Run application tests
- [`wheels analyze`](/v3-1-0/command-line-tools/commands/analysis/analyze-code/) - Code quality analysis
- [`wheels deps`](/v3-1-0/command-line-tools/commands/core/deps/) - Dependency vulnerability scan

## Additional Resources

- [Verification](/v3-1-0/handling-requests-with-controllers/verification/)
- [Request Handling](/v3-1-0/handling-requests-with-controllers/request-handling/)