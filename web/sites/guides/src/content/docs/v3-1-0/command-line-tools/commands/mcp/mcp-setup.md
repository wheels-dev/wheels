...
- [MCP Configuration Guide](/v3-1-0/command-line-tools/commands/mcp/mcp-configuration-guide/) — deeper details on transports, per-IDE setup, troubleshooting
- [MCP Status](/v3-1-0/command-line-tools/commands/mcp/mcp-status/) — check current MCP configuration
- [MCP Test](/v3-1-0/command-line-tools/commands/mcp/mcp-test/) — verify MCP connectivity
- [MCP Remove](/v3-1-0/command-line-tools/commands/mcp/mcp-remove/) — remove MCP integration
