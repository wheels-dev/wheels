...
- [`wheels mcp setup`](/v3-1-0/command-line-tools/commands/mcp/mcp-setup/) - Configure MCP integration
- [`wheels mcp status`](/v3-1-0/command-line-tools/commands/mcp/mcp-status/) - Check MCP status
- [`wheels mcp update`](/v3-1-0/command-line-tools/commands/mcp/mcp-update/) - Update MCP configuration
