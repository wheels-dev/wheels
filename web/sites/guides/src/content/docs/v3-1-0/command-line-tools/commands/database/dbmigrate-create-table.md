...
- [`wheels dbmigrate create column`](/v3-1-0/command-line-tools/commands/database/dbmigrate-create-column/) - Add columns to existing table
- [`wheels dbmigrate create blank`](/v3-1-0/command-line-tools/commands/database/dbmigrate-create-blank/) - Create custom migration
- [`wheels dbmigrate remove table`](/v3-1-0/command-line-tools/commands/database/dbmigrate-remove-table/) - Create table removal migration
