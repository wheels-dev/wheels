...
- [wheels dbmigrate latest](/v3-1-0/command-line-tools/commands/database/dbmigrate-latest/) — apply pending migrations
- [wheels dbmigrate info](/v3-1-0/command-line-tools/commands/database/dbmigrate-info/) — migration status
- [wheels dbmigrate create column](/v3-1-0/command-line-tools/commands/database/dbmigrate-create-column/) — manually scaffold a column-change migration
