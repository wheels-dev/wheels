...
- [wheels generate scaffold](/v3-1-0/command-line-tools/commands/generate/scaffold/) - Generate scaffolding
- [wheels dbmigrate remove table](/v3-1-0/command-line-tools/commands/database/dbmigrate-remove-table/) - Remove database tables