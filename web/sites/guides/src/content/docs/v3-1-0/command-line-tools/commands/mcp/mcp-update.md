...
- [`wheels mcp setup`](/v3-1-0/command-line-tools/commands/mcp/mcp-setup/) - Initial MCP configuration
- [`wheels mcp status`](/v3-1-0/command-line-tools/commands/mcp/mcp-status/) - Check current status
- [`wheels mcp test`](/v3-1-0/command-line-tools/commands/mcp/mcp-test/) - Test MCP functionality
