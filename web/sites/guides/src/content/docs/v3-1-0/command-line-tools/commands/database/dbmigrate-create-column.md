...
- [`wheels dbmigrate create table`](/v3-1-0/command-line-tools/commands/database/dbmigrate-create-table/) - Create new tables
- [`wheels dbmigrate create blank`](/v3-1-0/command-line-tools/commands/database/dbmigrate-create-blank/) - Create custom migrations
- [`wheels dbmigrate remove table`](/v3-1-0/command-line-tools/commands/database/dbmigrate-remove-table/) - Remove tables
- [`wheels dbmigrate up`](/v3-1-0/command-line-tools/commands/database/dbmigrate-up/) - Run migrations
- [`wheels dbmigrate down`](/v3-1-0/command-line-tools/commands/database/dbmigrate-down/) - Rollback migrations