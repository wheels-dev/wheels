...
- [`wheels about`](/v3-1-0/command-line-tools/commands/application-utilities/about/) - Display comprehensive application information
...
- [`wheels test run`](/v3-1-0/command-line-tools/commands/test/test-run/) - Run tests to ensure code quality
- [`wheels analyze`](/v3-1-0/command-line-tools/commands/analysis/analyze/) - Deep code analysis
- [`wheels deps`](/v3-1-0/command-line-tools/commands/core/deps/) - Manage Wheels-specific dependencies
