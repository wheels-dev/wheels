...
Install Playwright browsers. Use this command after [`wheels playwright:init`](/v3-1-0/command-line-tools/commands/playwright/playwright-init/) if browser installation failed, or to install specific browsers.
...
- [`wheels playwright:init`](/v3-1-0/command-line-tools/commands/playwright/playwright-init/) - Initialize Playwright project
