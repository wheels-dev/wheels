...
- [wheels plugin info](/v3-1-0/command-line-tools/commands/plugins/plugins-info/) - View detailed plugin information
- [wheels plugin install](/v3-1-0/command-line-tools/commands/plugins/plugins-install/) - Install a plugin
- [wheels plugin list](/v3-1-0/command-line-tools/commands/plugins/plugins-list/) - List installed plugins
- [wheels plugin outdated](/v3-1-0/command-line-tools/commands/plugins/plugins-outdated/) - Check for plugin updates
