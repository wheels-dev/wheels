...
- [`wheels mcp setup`](/v3-1-0/command-line-tools/commands/mcp/mcp-setup/) — Auto-generate MCP configuration files
- [`wheels mcp status`](/v3-1-0/command-line-tools/commands/mcp/mcp-status/) — Check current integration status
- [`wheels mcp test`](/v3-1-0/command-line-tools/commands/mcp/mcp-test/) — Test MCP connection and tools
- [`wheels mcp update`](/v3-1-0/command-line-tools/commands/mcp/mcp-update/) — Update existing configuration
- [`wheels mcp remove`](/v3-1-0/command-line-tools/commands/mcp/mcp-remove/) — Remove MCP integration
