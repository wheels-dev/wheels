...
See [Template System Guide](/v3-1-0/command-line-tools/cli-guides/template-system/) for detailed documentation.
...
- [Creating Custom Commands](/v3-1-0/command-line-tools/cli-guides/creating-commands/)
- [Template System](/v3-1-0/command-line-tools/cli-guides/template-system/)
