...
- [`wheels db drop`](/v3-1-0/command-line-tools/commands/database/db-drop/) - Drop an existing database
- [`wheels dbmigrate latest`](/v3-1-0/command-line-tools/commands/database/dbmigrate-latest/) - Run migrations after creating database