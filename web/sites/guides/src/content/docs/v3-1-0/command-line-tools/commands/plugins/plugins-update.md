...
- [wheels plugin update:all](/v3-1-0/command-line-tools/commands/plugins/plugins-update-all/) - Update all plugins
- [wheels plugin outdated](/v3-1-0/command-line-tools/commands/plugins/plugins-outdated/) - Check for outdated plugins
- [wheels plugin info](/v3-1-0/command-line-tools/commands/plugins/plugins-info/) - View plugin details
