...
- [`wheels dbmigrate create table`](/v3-1-0/command-line-tools/commands/database/dbmigrate-create-table/) - Create a table migration
- [`wheels dbmigrate create column`](/v3-1-0/command-line-tools/commands/database/dbmigrate-create-column/) - Create a column migration
