...
- [Creating Commands](/v3-1-0/command-line-tools/cli-guides/creating-commands/) - Build custom generators
- [Service Architecture](/v3-1-0/command-line-tools/cli-guides/service-architecture/) - Understand the template service
- [wheels scaffold](/v3-1-0/command-line-tools/commands/generate/scaffold/) - Main scaffold documentation