...
- [`wheels version`](/v3-1-0/command-line-tools/commands/core/info/#version) - Show just version information
- [`wheels env list`](/v3-1-0/command-line-tools/commands/environment/env-list/) - List environments
