...
- [wheels dbmigrate up](/v3-1-0/command-line-tools/commands/database/dbmigrate-up/) - Run next migration
- [wheels dbmigrate down](/v3-1-0/command-line-tools/commands/database/dbmigrate-down/) - Rollback migration
- [wheels dbmigrate create blank](/v3-1-0/command-line-tools/commands/database/dbmigrate-create-blank/) - Create new migration