...
- [CLI Overview](/v3-1-0/command-line-tools/cli-overview/) — Full CLI documentation
- [Quick Start Guide](/v3-1-0/command-line-tools/quick-start/) — Getting started from scratch
- [Template System](/v3-1-0/command-line-tools/cli-guides/template-system/) — Customize code generation
- [Testing Guide](/v3-1-0/command-line-tools/cli-guides/testing/) — Write and run tests
