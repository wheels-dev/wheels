...
For a full migration guide, see [Migrating from CommandBox](/v3-1-0/command-line-tools/cli-guides/migration-from-commandbox/).
...
- Use **`.env` files** for values that change per environment (database credentials, ports, feature flags). See [Configuration Management](/v3-1-0/command-line-tools/configuration/).
