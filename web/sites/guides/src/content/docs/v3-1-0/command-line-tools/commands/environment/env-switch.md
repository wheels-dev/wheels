...
- [wheels env list](/v3-1-0/command-line-tools/commands/environment/env-list/) - List available environments
- [wheels env setup](/v3-1-0/command-line-tools/commands/environment/env-setup/) - Setup new environments
