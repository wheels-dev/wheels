...
```javascript title="/app/controllers/User.cfc"
...
```javascript title="/app/views/users/new.cfm"
...
```javascript title="/app/controllers/Users.cfc"
function create() {
...
```javascript title="/app/models/Address.cfc"
component extends="Model" {
...
```javascript title="/app/views/users/_form.cfm"
#startFormTag(action="create")#
...
```javascript title="/app/views/users/_address.cfm"
<div class="address">
    #textField(
        label="Street",
        objectName="user",
...
```javascript title="/app/views/customers/edit.cfm"
