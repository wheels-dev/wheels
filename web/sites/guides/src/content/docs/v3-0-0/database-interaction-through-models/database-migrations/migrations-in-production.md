...
To activate this feature, just use `set(autoMigrateDatabase=true)` in your `config/production/settings.cfm` settings, to ensure it only fires in production mode.
