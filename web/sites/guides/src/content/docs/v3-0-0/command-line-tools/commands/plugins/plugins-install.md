...
- [wheels plugin update](/v3-0-0/command-line-tools/commands/plugins/plugins-update/) - Update a plugin
- [wheels plugin remove](/v3-0-0/command-line-tools/commands/plugins/plugins-remove/) - Remove a plugin
