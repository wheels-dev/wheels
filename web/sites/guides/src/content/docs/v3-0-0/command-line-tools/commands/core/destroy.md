...
- [wheels generate resource](/v3-0-0/command-line-tools/commands/generate/resource/) - Generate resources
- [wheels generate scaffold](/v3-0-0/command-line-tools/commands/generate/scaffold/) - Generate scaffolding
- [wheels dbmigrate remove table](/v3-0-0/command-line-tools/commands/database/dbmigrate-remove-table/) - Remove database tables