...
- [wheels dbmigrate up](/v3-0-0/command-line-tools/commands/database/dbmigrate-up/) - Run single migration
- [wheels dbmigrate down](/v3-0-0/command-line-tools/commands/database/dbmigrate-down/) - Rollback migration
- [wheels dbmigrate create blank](/v3-0-0/command-line-tools/commands/database/dbmigrate-create-blank/) - Create migration