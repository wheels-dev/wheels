...
- [wheels init](/v3-0-0/command-line-tools/commands/core/init/) - Initialize existing application
- [wheels generate app-wizard](/v3-0-0/command-line-tools/commands/generate/app-wizard/) - Interactive app creation
- [wheels scaffold](/v3-0-0/command-line-tools/commands/generate/scaffold/) - Generate CRUD scaffolding
