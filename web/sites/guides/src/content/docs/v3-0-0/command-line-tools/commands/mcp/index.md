...
### Core Commands
- [`wheels mcp setup`](/v3-0-0/command-line-tools/commands/mcp/mcp-setup/) - Configure MCP integration for AI IDEs
- [`wheels mcp status`](/v3-0-0/command-line-tools/commands/mcp/mcp-status/) - Check current MCP integration status
- [`wheels mcp test`](/v3-0-0/command-line-tools/commands/mcp/mcp-test/) - Test MCP connection and functionality
