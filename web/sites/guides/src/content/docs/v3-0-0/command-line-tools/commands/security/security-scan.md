...
- [`wheels test`](/v3-0-0/command-line-tools/commands/test/test-run/) - Run application tests
- [`wheels analyze`](/v3-0-0/command-line-tools/commands/analysis/analyze-code/) - Code quality analysis
- [`wheels deps`](/v3-0-0/command-line-tools/commands/core/deps/) - Dependency vulnerability scan

## Additional Resources

- [Wheels Security Guide](/v3-0-0/command-line-tools/handling-requests-with-controllers/verification/)
- [CSRF Protection Documentation](/v3-0-0/command-line-tools/handling-requests-with-controllers/request-handling/)
- [Authentication Patterns](/v3-0-0/command-line-tools/database-interaction-through-models/)