...
- [wheels plugin update](/v3-0-0/command-line-tools/commands/plugins/plugins-update/) - Update a single plugin
- [wheels plugin outdated](/v3-0-0/command-line-tools/commands/plugins/plugins-outdated/) - Check for outdated plugins
- [wheels plugin list](/v3-0-0/command-line-tools/commands/plugins/plugins-list/) - List installed plugins
- [wheels plugin info](/v3-0-0/command-line-tools/commands/plugins/plugins-info/) - View plugin details
