...
- [`wheels dbmigrate create table`](/v3-0-0/command-line-tools/commands/database/dbmigrate-create-table/) - Create tables
...
- [`wheels db schema`](/v3-0-0/command-line-tools/commands/database/db-schema/) - Export table schemas