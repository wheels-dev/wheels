...
- [`wheels version`](/v3-0-0/command-line-tools/commands/core/info/#version) - Show just version information
- [`wheels doctor`](/v3-0-0/command-line-tools/commands/application-utilities/doctor/) - Run health checks
- [`wheels stats`](/v3-0-0/command-line-tools/commands/application-utilities/stats/) - Detailed code statistics
