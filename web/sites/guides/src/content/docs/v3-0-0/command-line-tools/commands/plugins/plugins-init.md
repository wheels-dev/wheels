...
- [wheels plugin install](/v3-0-0/command-line-tools/commands/plugins/plugins-install/) - Install plugins from ForgeBox
...
- [Developing Plugins](/v3-0-0/plugins/developing-plugins/) - Full plugin development guide
