...
- [`wheels dbmigrate up`](/v3-0-0/command-line-tools/commands/database/dbmigrate-up/) - Run the next migration
- [`wheels dbmigrate down`](/v3-0-0/command-line-tools/commands/database/dbmigrate-down/) - Rollback last migration
- [`wheels dbmigrate latest`](/v3-0-0/command-line-tools/commands/database/dbmigrate-latest/) - Run all pending migrations
- [`wheels dbmigrate info`](/v3-0-0/command-line-tools/commands/database/dbmigrate-info/) - View migration status
- [`wheels dbmigrate create blank`](/v3-0-0/command-line-tools/commands/database/dbmigrate-create-blank/) - Create a new migration