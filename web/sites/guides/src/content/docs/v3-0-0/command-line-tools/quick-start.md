...
1. **Read the Guides:**
   - [Service Architecture](/v3-0-0/command-line-tools/service-architecture/)
   - [Testing Guide](/v3-0-0/command-line-tools/testing/)
   - [Migration Guide](/v3-0-0/command-line-tools/migrations/)
