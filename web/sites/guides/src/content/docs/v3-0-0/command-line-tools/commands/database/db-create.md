...
- [`wheels db drop`](/v3-0-0/command-line-tools/commands/database/db-drop/) - Drop an existing database
- [`wheels db setup`](/v3-0-0/command-line-tools/commands/database/db-setup/) - Create and setup database
- [`wheels dbmigrate latest`](/v3-0-0/command-line-tools/commands/database/dbmigrate-latest/) - Run migrations after creating database