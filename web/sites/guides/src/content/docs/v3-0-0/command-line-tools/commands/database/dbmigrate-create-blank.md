...
- [`wheels dbmigrate create table`](/v3-0-0/command-line-tools/commands/database/dbmigrate-create-table/) - Create a table migration
- [`wheels dbmigrate create column`](/v3-0-0/command-line-tools/commands/database/dbmigrate-create-column/) - Create a column migration
- [`wheels dbmigrate up`](/v3-0-0/command-line-tools/commands/database/dbmigrate-up/) - Run migrations
- [`wheels dbmigrate down`](/v3-0-0/command-line-tools/commands/database/dbmigrate-down/) - Rollback migrations
