...
- [wheels init](/v3-0-0/command-line-tools/commands/core/init/) - Initialize a Wheels application
- [wheels plugins](/v3-0-0/command-line-tools/commands/plugins/plugins/) - Manage Wheels CLI plugins