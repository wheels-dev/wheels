...
- [wheels generate model](/v3-0-0/command-line-tools/commands/generate/model/) - Generate models only
- [wheels generate controller](/v3-0-0/command-line-tools/commands/generate/controller/) - Generate controllers only
- [wheels generate view](/v3-0-0/command-line-tools/commands/generate/view/) - Generate views only
