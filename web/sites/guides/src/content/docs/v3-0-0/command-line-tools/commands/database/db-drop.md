...
- [`wheels db create`](/v3-0-0/command-line-tools/commands/database/db-create/) - Create a new database
- [`wheels db reset`](/v3-0-0/command-line-tools/commands/database/db-reset/) - Drop and recreate database
- [`wheels db dump`](/v3-0-0/command-line-tools/commands/database/db-dump/) - Backup before dropping