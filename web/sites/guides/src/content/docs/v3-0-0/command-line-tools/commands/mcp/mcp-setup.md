...
- [`wheels mcp status`](/v3-0-0/command-line-tools/commands/mcp/mcp-status/) - Check MCP integration status
- [`wheels mcp test`](/v3-0-0/command-line-tools/commands/mcp/mcp-test/) - Test MCP connection
