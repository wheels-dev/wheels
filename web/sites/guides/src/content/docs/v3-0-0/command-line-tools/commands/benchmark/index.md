...
- [`wheels benchmark run`](/v3-0-0/command-line-tools/commands/benchmark/benchmark-run/) - Run performance benchmarks
- [`wheels benchmark compare`](/v3-0-0/command-line-tools/commands/benchmark/benchmark-compare/) - Compare benchmark results
- [`wheels benchmark report`](/v3-0-0/command-line-tools/commands/benchmark/benchmark-report/) - Generate performance reports

### Specialized Benchmarks
- [`wheels benchmark database`](/v3-0-0/command-line-tools/commands/benchmark/benchmark-database/) - Database query performance
- [`wheels benchmark memory`](/v3-0-0/command-line-tools/commands/benchmark/benchmark-memory/) - Memory usage analysis
- [`wheels benchmark load`](/v3-0-0/command-line-tools/commands/benchmark/benchmark-load/) - Load testing and stress testing
...
- [Performance Optimization Guide](/v3-0-0/command-line-tools/working-with-wheels/performance-optimization/)
- [Database Optimization](/v3-0-0/command-line-tools/database-interaction-through-models/performance/)
- [Caching Strategies](/v3-0-0/command-line-tools/working-with-wheels/caching/)
