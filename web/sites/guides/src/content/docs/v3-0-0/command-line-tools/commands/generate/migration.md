...
- [wheels dbmigrate latest](/v3-0-0/command-line-tools/commands/database/dbmigrate-latest/) - Run migrations
- [wheels dbmigrate info](/v3-0-0/command-line-tools/commands/database/dbmigrate-info/) - Check migration status
- [wheels dbmigrate create table](/v3-0-0/command-line-tools/commands/database/dbmigrate-create-table/) - Alternative table creation
- [wheels dbmigrate create blank](/v3-0-0/command-line-tools/commands/database/dbmigrate-create-blank/) - Alternative blank migration
- [wheels generate model](/v3-0-0/command-line-tools/commands/generate/model/) - Generate models
- [Database Migrations Guide](/v3-0-0/command-line-tools/cli-guides/migrations/) - Migration best practices
- [Template System Guide](/v3-0-0/command-line-tools/cli-guides/template-system/) - Customize templates
