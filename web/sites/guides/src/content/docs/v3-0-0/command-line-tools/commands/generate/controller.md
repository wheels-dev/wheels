...
- [wheels generate view](/v3-0-0/command-line-tools/commands/generate/view/) - Generate views
- [wheels scaffold](/v3-0-0/command-line-tools/commands/generate/scaffold/) - Generate complete CRUD
- [wheels generate test](/v3-0-0/command-line-tools/commands/generate/test/) - Generate controller tests