...
- [`wheels dbmigrate reset`](/v3-0-0/command-line-tools/commands/database/dbmigrate-reset/) - Reset all migrations
- [`wheels dbmigrate info`](/v3-0-0/command-line-tools/commands/database/dbmigrate-info/) - View migration status
- [`wheels dbmigrate exec`](/v3-0-0/command-line-tools/commands/database/dbmigrate-exec/) - Run a specific migration