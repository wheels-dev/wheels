...
- [`wheels dbmigrate create table`](/v3-0-0/command-line-tools/commands/database/dbmigrate-create-table/) - Create new tables
- [`wheels dbmigrate create blank`](/v3-0-0/command-line-tools/commands/database/dbmigrate-create-blank/) - Create custom migrations
- [`wheels dbmigrate remove table`](/v3-0-0/command-line-tools/commands/database/dbmigrate-remove-table/) - Remove tables
