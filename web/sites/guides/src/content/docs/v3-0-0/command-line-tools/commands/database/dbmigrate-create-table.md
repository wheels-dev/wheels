...
- [`wheels dbmigrate create column`](/v3-0-0/command-line-tools/commands/database/dbmigrate-create-column/) - Add columns to existing table
- [`wheels dbmigrate create blank`](/v3-0-0/command-line-tools/commands/database/dbmigrate-create-blank/) - Create custom migration
- [`wheels dbmigrate remove table`](/v3-0-0/command-line-tools/commands/database/dbmigrate-remove-table/) - Create table removal migration
- [`wheels dbmigrate up`](/v3-0-0/command-line-tools/commands/database/dbmigrate-up/) - Run migrations
- [`wheels dbmigrate info`](/v3-0-0/command-line-tools/commands/database/dbmigrate-info/) - View migration status