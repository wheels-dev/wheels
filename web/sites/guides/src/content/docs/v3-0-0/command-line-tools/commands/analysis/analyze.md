...
- [wheels analyze code](/v3-0-0/command-line-tools/commands/analysis/analyze-code/) - Code quality analysis
- [wheels analyze performance](/v3-0-0/command-line-tools/commands/analysis/analyze-performance/) - Performance analysis
- [wheels test](/v3-0-0/command-line-tools/commands/testing/test/) - Run tests