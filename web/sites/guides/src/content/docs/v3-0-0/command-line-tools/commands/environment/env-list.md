...
- [wheels env setup](/v3-0-0/command-line-tools/commands/environment/env-setup/) - Setup new environment
- [wheels env switch](/v3-0-0/command-line-tools/commands/environment/env-switch/) - Switch environments
- [wheels config list](/v3-0-0/command-line-tools/commands/config/config-list/) - List configuration