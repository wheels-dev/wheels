...
The call to [includeContent()](https://wheels.dev/api/v3.0.0/controller.includecontent.html) represents the output of your page generated by your view files. Whatever code you put before this snippet will be run before the view. Similarly, whatever code you put after the snippet will be run afterward
