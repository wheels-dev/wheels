...
<Aside type="note">
  You should already know [Environments and Configuration](/v4-0-0-snapshot/core-concepts/environments-and-configuration/). This guide is task-oriented — it assumes you've shipped at least one Wheels app in development.
</Aside>
