...
<Aside type="note">
  You should already be comfortable editing `config/settings.cfm` and activating packages. See [Packages](/v4-0-0-snapshot/digging-deeper/packages/) for the `packages/` → `vendor/` activation model.
</Aside>
