...
<Aside type="note">
  You should already be comfortable editing `config/settings.cfm` and installing packages. See [Packages](/v4-0-0-snapshot/digging-deeper/packages/) for the registry-based distribution and `vendor/` activation model.
</Aside>
