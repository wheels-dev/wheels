...
- Java 21. Lucee 7 runs on Java 21 — confirmed by the Wheels test image, which pins `lucee@7.0.1+100` ([`tools/docker/lucee7/Dockerfile`](https://github.com/cfwheels/cfwheels/blob/main/tools/docker/lucee7/Dockerfile)).
