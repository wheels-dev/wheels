...
- [wheels dbmigrate latest](/v4-0-0-snapshot/command-line-tools/commands/database/dbmigrate-latest/) — apply pending migrations
- [wheels dbmigrate info](/v4-0-0-snapshot/command-line-tools/commands/database/dbmigrate-info/) — migration status
- [wheels dbmigrate create column](/v4-0-0-snapshot/command-line-tools/commands/database/dbmigrate-create-column/) — manually scaffold a column-change migration
