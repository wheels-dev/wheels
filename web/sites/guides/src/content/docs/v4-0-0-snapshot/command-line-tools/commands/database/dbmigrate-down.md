...
- [`wheels dbmigrate reset`](/v4-0-0-snapshot/command-line-tools/commands/database/dbmigrate-reset/) - Reset all migrations
- [`wheels dbmigrate info`](/v4-0-0-snapshot/command-line-tools/commands/database/dbmigrate-info/) - View migration status
- [`wheels dbmigrate exec`](/v4-0-0-snapshot/command-line-tools/commands/database/dbmigrate-exec/) - Run a specific migration