---
title: wheels generate property
---
...
- [wheels dbmigrate create column](/v4-0-0-snapshot/command-line-tools/commands/database/dbmigrate-create-column/) - Create columns
