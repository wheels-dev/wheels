...
- [wheels docker deploy](/v4-0-0-snapshot/command-line-tools/commands/docker/docker-deploy/) - Build and deploy Docker containers
...
**Note**: This command is part of the Wheels CLI tool suite for Docker management.# wheels docker logs
