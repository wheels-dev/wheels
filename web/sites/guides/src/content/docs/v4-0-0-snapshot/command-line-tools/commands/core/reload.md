...
- [wheels init](/v4-0-0-snapshot/command-line-tools/commands/core/init/) - Initialize application configuration=
- [wheels info](/v4-0-0-snapshot/command-line-tools/commands/core/info/) - Display application information