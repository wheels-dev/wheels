...
- [wheels init](/v4-0-0-snapshot/command-line-tools/commands/core/init/) - Initialize existing application
- [wheels generate app-wizard](/v4-0-0-snapshot/command-line-tools/commands/generate/app-wizard/) - Interactive app creation
- [wheels scaffold](/v4-0-0-snapshot/command-line-tools/commands/generate/scaffold/) - Generate CRUD scaffolding
