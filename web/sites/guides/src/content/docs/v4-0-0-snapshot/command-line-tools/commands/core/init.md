...
- [wheels generate app](/v4-0-0-snapshot/command-line-tools/commands/generate/app/) - Create a new Wheels application
- [wheels reload](/v4-0-0-snapshot/command-line-tools/commands/core/reload/) - Reload the application
- [wheels info](/v4-0-0-snapshot/command-line-tools/commands/core/info/) - Display version information
