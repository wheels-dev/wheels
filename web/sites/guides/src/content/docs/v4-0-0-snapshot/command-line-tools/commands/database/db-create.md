...
- [`wheels db drop`](/v4-0-0-snapshot/command-line-tools/commands/database/db-drop/) - Drop an existing database
- [`wheels dbmigrate latest`](/v4-0-0-snapshot/command-line-tools/commands/database/dbmigrate-latest/) - Run migrations after creating database