...
- [`wheels dbmigrate up`](/v4-0-0-snapshot/command-line-tools/commands/database/dbmigrate-up/) - Run the next migration
- [`wheels dbmigrate down`](/v4-0-0-snapshot/command-line-tools/commands/database/dbmigrate-down/) - Rollback last migration
- [`wheels dbmigrate latest`](/v4-0-0-snapshot/command-line-tools/commands/database/dbmigrate-latest/) - Run all pending migrations
- [`wheels dbmigrate info`](/v4-0-0-snapshot/command-line-tools/commands/database/dbmigrate-info/) - View migration status
- [`wheels dbmigrate create blank`](/v4-0-0-snapshot/command-line-tools/commands/database/dbmigrate-create-blank/) - Create a new migration