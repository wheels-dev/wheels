...
- [wheels plugin update](/v4-0-0-snapshot/command-line-tools/commands/plugins/plugins-update/) - Update a plugin
- [wheels plugin remove](/v4-0-0-snapshot/command-line-tools/commands/plugins/plugins-remove/) - Remove a plugin
