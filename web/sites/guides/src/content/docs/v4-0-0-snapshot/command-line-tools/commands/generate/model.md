...
- [wheels dbmigrate create table](/v4-0-0-snapshot/command-line-tools/commands/database/dbmigrate-create-table/) - Create migrations
- [wheels generate property](/v4-0-0-snapshot/command-line-tools/commands/generate/property/) - Add properties to existing models
- [wheels generate controller](/v4-0-0-snapshot/command-line-tools/commands/generate/controller/) - Generate controllers
- [wheels scaffold](/v4-0-0-snapshot/command-line-tools/commands/generate/scaffold/) - Generate complete CRUD