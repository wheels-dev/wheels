...
- [wheels generate scaffold](/v4-0-0-snapshot/command-line-tools/commands/generate/scaffold/) - Generate scaffolding
- [wheels dbmigrate remove table](/v4-0-0-snapshot/command-line-tools/commands/database/dbmigrate-remove-table/) - Remove database tables