...
- [`wheels version`](/v4-0-0-snapshot/command-line-tools/commands/core/info/#version) - Show just version information
- [`wheels env list`](/v4-0-0-snapshot/command-line-tools/commands/environment/env-list/) - List environments
