...
- [`wheels mcp setup`](/v4-0-0-snapshot/command-line-tools/commands/mcp/mcp-setup/) - Initial MCP configuration
- [`wheels mcp status`](/v4-0-0-snapshot/command-line-tools/commands/mcp/mcp-status/) - Check current status
- [`wheels mcp test`](/v4-0-0-snapshot/command-line-tools/commands/mcp/mcp-test/) - Test MCP functionality
