...
- [`wheels about`](/v4-0-0-snapshot/command-line-tools/commands/application-utilities/about/) - Display comprehensive application information
...
- [`wheels test run`](/v4-0-0-snapshot/command-line-tools/commands/test/test-run/) - Run tests to ensure code quality
- [`wheels analyze`](/v4-0-0-snapshot/command-line-tools/commands/analysis/analyze/) - Deep code analysis
- [`wheels deps`](/v4-0-0-snapshot/command-line-tools/commands/core/deps/) - Manage Wheels-specific dependencies
