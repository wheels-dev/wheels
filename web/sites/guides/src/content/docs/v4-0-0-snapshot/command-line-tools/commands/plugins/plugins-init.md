...
- [wheels plugin install](/v4-0-0-snapshot/command-line-tools/commands/plugins/plugins-install/) - Install plugins from ForgeBox
- [wheels plugin list](/v4-0-0-snapshot/command-line-tools/commands/plugins/plugins-list/) - List installed plugins
- [wheels reload](/v4-0-0-snapshot/command-line-tools/commands/core/reload/) - Reload application
- [Developing Plugins](/v4-0-0-snapshot/plugins/developing-plugins/) - Full plugin development guide
