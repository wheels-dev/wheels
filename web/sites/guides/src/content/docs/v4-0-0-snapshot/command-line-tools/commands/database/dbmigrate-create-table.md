...
- [`wheels dbmigrate create column`](/v4-0-0-snapshot/command-line-tools/commands/database/dbmigrate-create-column/) - Add columns to existing table
- [`wheels dbmigrate create blank`](/v4-0-0-snapshot/command-line-tools/commands/database/dbmigrate-create-blank/) - Create custom migration
- [`wheels dbmigrate remove table`](/v4-0-0-snapshot/command-line-tools/commands/database/dbmigrate-remove-table/) - Create table removal migration
- [`wheels dbmigrate up`](/v4-0-0-snapshot/command-line-tools/commands/database/dbmigrate-up/) - Run migrations
- [`wheels dbmigrate info`](/v4-0-0-snapshot/command-line-tools/commands/database/dbmigrate-info/) - View migration status