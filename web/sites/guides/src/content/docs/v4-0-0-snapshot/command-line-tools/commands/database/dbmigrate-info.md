...
- [wheels dbmigrate up](/v4-0-0-snapshot/command-line-tools/commands/database/dbmigrate-up/) - Run next migration
- [wheels dbmigrate down](/v4-0-0-snapshot/command-line-tools/commands/database/dbmigrate-down/) - Rollback migration
- [wheels dbmigrate create blank](/v4-0-0-snapshot/command-line-tools/commands/database/dbmigrate-create-blank/) - Create new migration