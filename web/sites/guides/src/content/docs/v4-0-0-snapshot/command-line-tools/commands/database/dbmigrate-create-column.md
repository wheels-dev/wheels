...
- [`wheels dbmigrate create table`](/v4-0-0-snapshot/command-line-tools/commands/database/dbmigrate-create-table/) - Create new tables
- [`wheels dbmigrate create blank`](/v4-0-0-snapshot/command-line-tools/commands/database/dbmigrate-create-blank/) - Create custom migrations
- [`wheels dbmigrate remove table`](/v4-0-0-snapshot/command-line-tools/commands/database/dbmigrate-remove-table/) - Remove tables
