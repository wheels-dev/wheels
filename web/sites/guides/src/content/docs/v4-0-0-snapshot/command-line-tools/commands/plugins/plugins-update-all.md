---
title: "wheels plugin update:all"
---
...
- [wheels plugin update](/v4-0-0-snapshot/command-line-tools/commands/plugins/plugins-update/) - Update a single plugin
- [wheels plugin outdated](/v4-0-0-snapshot/command-line-tools/commands/plugins/plugins-outdated/) - Check for outdated plugins
- [wheels plugin list](/v4-0-0-snapshot/command-line-tools/commands/plugins/plugins-list/) - List installed plugins
- [wheels plugin info](/v4-0-0-snapshot/command-line-tools/commands/plugins/plugins-info/) - View plugin details
