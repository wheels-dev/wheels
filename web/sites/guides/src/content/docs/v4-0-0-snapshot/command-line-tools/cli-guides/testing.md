...
- [wheels test run](/v4-0-0-snapshot/command-line-tools/commands/test/test-run/) - Test execution command
- [wheels test advanced](/v4-0-0-snapshot/command-line-tools/commands/test/test-advanced/) - Advanced test options
