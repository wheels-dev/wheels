...
### [Command Reference](/v4-0-0-snapshot/command-line-tools/commands/)
Complete reference for all CLI commands organized by category:
- [Core Commands](/v4-0-0-snapshot/command-line-tools/commands/core/init/) - Essential commands like init, reload.
- [Code Generation](/v4-0-0-snapshot/command-line-tools/commands/generate/app/) - Generate applications, models, controllers, views
- [Database Commands](/v4-0-0-snapshot/command-line-tools/commands/database/db-create/) - Complete database management and migrations
- [Testing Commands](/v4-0-0-snapshot/command-line-tools/commands/test/test-run/) - Run tests and generate coverage
- [Configuration](/v4-0-0-snapshot/command-line-tools/commands/config/config-dump/) - Manage application settings
- [And more...](/v4-0-0-snapshot/command-line-tools/commands/)
...
#### Development Guides
- [Service Architecture](/v4-0-0-snapshot/command-line-tools/cli-guides/service-architecture/) - Understand the CLI's architecture
- [Creating Custom Commands](/v4-0-0-snapshot/command-line-tools/cli-guides/creating-commands/) - Extend the CLI with your own commands
- [Template System](/v4-0-0-snapshot/command-line-tools/cli-guides/template-system/) - Customize code generation templates
- [Testing Guide](/v4-0-0-snapshot/command-line-tools/cli-guides/testing/) - Write and run tests effectively

#### Switching CLIs
- [Migrating from CommandBox to LuCLI](/v4-0-0-snapshot/command-line-tools/cli-guides/migration-from-commandbox/) - Command mapping, config changes, and side-by-side usage

#### Best Practices
- [Migration Guide](/v4-0-0-snapshot/command-line-tools/cli-guides/migrations/) - Database migration best practices
- [Configuration](/v4-0-0-snapshot/command-line-tools/configuration/) - All available configuration settings
...
- [All Commands](/v4-0-0-snapshot/command-line-tools/commands/) - Complete command reference
- [Quick Start](/v4-0-0-snapshot/command-line-tools/quick-start/) - Get started in minutes
- [Creating Commands](/v4-0-0-snapshot/command-line-tools/cli-guides/creating-commands/) - Extend the CLI
- [Service Architecture](/v4-0-0-snapshot/command-line-tools/cli-guides/service-architecture/) - Technical deep dive
- [Testing Guide](/v4-0-0-snapshot/command-line-tools/cli-guides/testing/) - Testing best practices
...
Ready to get started? Head to the [Quick Start Guide](/v4-0-0-snapshot/command-line-tools/quick-start/) or explore the [Command Reference](/v4-0-0-snapshot/command-line-tools/commands/).
