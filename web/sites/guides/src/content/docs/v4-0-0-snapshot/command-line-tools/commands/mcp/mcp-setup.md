...
- [MCP Configuration Guide](/v4-0-0-snapshot/command-line-tools/commands/mcp/mcp-configuration-guide/) — deeper details on transports, per-IDE setup, troubleshooting
- [MCP Status](/v4-0-0-snapshot/command-line-tools/commands/mcp/mcp-status/) — check current MCP configuration
- [MCP Test](/v4-0-0-snapshot/command-line-tools/commands/mcp/mcp-test/) — verify MCP connectivity
- [MCP Remove](/v4-0-0-snapshot/command-line-tools/commands/mcp/mcp-remove/) — remove MCP integration
