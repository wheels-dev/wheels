...
See [Template System Guide](/v4-0-0-snapshot/command-line-tools/cli-guides/template-system/) for detailed documentation.
...
- [Creating Custom Commands](/v4-0-0-snapshot/command-line-tools/cli-guides/creating-commands/)
- [Template System](/v4-0-0-snapshot/command-line-tools/cli-guides/template-system/)
