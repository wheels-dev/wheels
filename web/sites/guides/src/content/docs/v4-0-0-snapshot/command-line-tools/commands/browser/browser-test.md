...
- [`wheels browser:install`](/v4-0-0-snapshot/command-line-tools/commands/browser/browser-install/) — Install Playwright
- [Browser Testing Guide](/v4-0-0-snapshot/command-line-tools/working-with-wheels/browser-testing/) — Full browser testing guide
