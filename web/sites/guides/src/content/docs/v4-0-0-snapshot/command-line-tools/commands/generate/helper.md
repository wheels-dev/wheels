...
- [wheels generate test](/v4-0-0-snapshot/command-line-tools/commands/generate/test/) - Generate tests
- [Template System Guide](/v4-0-0-snapshot/command-line-tools/cli-guides/template-system/) - Customize generator templates
