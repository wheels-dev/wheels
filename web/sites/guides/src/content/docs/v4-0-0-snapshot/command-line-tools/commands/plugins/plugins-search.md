...
- [wheels plugin info](/v4-0-0-snapshot/command-line-tools/commands/plugins/plugins-info/) - View detailed plugin information
- [wheels plugin install](/v4-0-0-snapshot/command-line-tools/commands/plugins/plugins-install/) - Install a plugin
- [wheels plugin list](/v4-0-0-snapshot/command-line-tools/commands/plugins/plugins-list/) - List installed plugins
- [wheels plugin outdated](/v4-0-0-snapshot/command-line-tools/commands/plugins/plugins-outdated/) - Check for plugin updates
