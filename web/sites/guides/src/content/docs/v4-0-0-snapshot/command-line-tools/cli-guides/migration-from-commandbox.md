---
title: Migrating from CommandBox to LuCLI
---
...
- [CLI Overview](/v4-0-0-snapshot/command-line-tools/cli-overview/) — Full CLI documentation
- [Quick Start Guide](/v4-0-0-snapshot/command-line-tools/quick-start/) — Getting started from scratch
- [Template System](/v4-0-0-snapshot/command-line-tools/cli-guides/template-system/) — Customize code generation
- [Testing Guide](/v4-0-0-snapshot/command-line-tools/cli-guides/testing/) — Write and run tests
