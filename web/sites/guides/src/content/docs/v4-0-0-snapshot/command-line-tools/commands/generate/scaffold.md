---
title: wheels generate scaffold
---
...
- [wheels generate model](/v4-0-0-snapshot/command-line-tools/commands/generate/model/) - Generate models only
- [wheels generate controller](/v4-0-0-snapshot/command-line-tools/commands/generate/controller/) - Generate controllers only
- [wheels generate view](/v4-0-0-snapshot/command-line-tools/commands/generate/view/) - Generate views only
