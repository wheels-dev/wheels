...
```bash title="illustrative — synopsis"
...
```bash title="illustrative — preview then force"
wheels destroy Post
...
```bash title="illustrative — undo scaffold"
wheels destroy Post --force
...
```bash title="illustrative — clean up aborted work"
...
```bash title="illustrative — re-scaffold under new name"
wheels destroy Post --force
