...
- [`wheels dbmigrate create table`](/v4-0-0-snapshot/command-line-tools/commands/database/dbmigrate-create-table/) - Create a table migration
- [`wheels dbmigrate create column`](/v4-0-0-snapshot/command-line-tools/commands/database/dbmigrate-create-column/) - Create a column migration
- [`wheels dbmigrate up`](/v4-0-0-snapshot/command-line-tools/commands/database/dbmigrate-up/) - Run migrations
- [`wheels dbmigrate down`](/v4-0-0-snapshot/command-line-tools/commands/database/dbmigrate-down/) - Rollback migrations
