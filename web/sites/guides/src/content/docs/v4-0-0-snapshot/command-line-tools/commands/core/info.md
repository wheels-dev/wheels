...
Current Wheels Version in this directory: 3.1.0-SNAPSHOT
====================================================================
```
...
- [wheels init](/v4-0-0-snapshot/command-line-tools/commands/core/init/) - Initialize a Wheels application
- [wheels deps](/v4-0-0-snapshot/command-line-tools/commands/core/deps/) - Manage dependencies