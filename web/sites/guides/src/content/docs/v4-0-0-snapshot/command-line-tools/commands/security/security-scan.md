...
- [`wheels test`](/v4-0-0-snapshot/command-line-tools/commands/test/test-run/) - Run application tests
- [`wheels analyze`](/v4-0-0-snapshot/command-line-tools/commands/analysis/analyze-code/) - Code quality analysis
- [`wheels deps`](/v4-0-0-snapshot/command-line-tools/commands/core/deps/) - Dependency vulnerability scan

## Additional Resources

- [Verification](/v4-0-0-snapshot/handling-requests-with-controllers/verification/)
- [Request Handling](/v4-0-0-snapshot/handling-requests-with-controllers/request-handling/)