---
title: wheels generate migration
---
...
- [wheels dbmigrate latest](/v4-0-0-snapshot/command-line-tools/commands/database/dbmigrate-latest/) - Run migrations
- [wheels dbmigrate info](/v4-0-0-snapshot/command-line-tools/commands/database/dbmigrate-info/) - Check migration status
- [wheels dbmigrate create table](/v4-0-0-snapshot/command-line-tools/commands/database/dbmigrate-create-table/) - Alternative table creation
- [wheels dbmigrate create blank](/v4-0-0-snapshot/command-line-tools/commands/database/dbmigrate-create-blank/) - Alternative blank migration
- [wheels generate model](/v4-0-0-snapshot/command-line-tools/commands/generate/model/) - Generate models
- [Database Migrations Guide](/v4-0-0-snapshot/command-line-tools/cli-guides/migrations/) - Migration best practices
- [Template System Guide](/v4-0-0-snapshot/command-line-tools/cli-guides/template-system/) - Customize templates
