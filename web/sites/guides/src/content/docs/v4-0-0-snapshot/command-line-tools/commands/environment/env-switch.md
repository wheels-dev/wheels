...
- [wheels env list](/v4-0-0-snapshot/command-line-tools/commands/environment/env-list/) - List available environments
- [wheels env setup](/v4-0-0-snapshot/command-line-tools/commands/environment/env-setup/) - Setup new environments
