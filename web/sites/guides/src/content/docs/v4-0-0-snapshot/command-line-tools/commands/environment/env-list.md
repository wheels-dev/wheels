...
- [wheels env setup](/v4-0-0-snapshot/command-line-tools/commands/environment/env-setup/) - Setup new environment
- [wheels env switch](/v4-0-0-snapshot/command-line-tools/commands/environment/env-switch/) - Switch environments
- [wheels config dump](/v4-0-0-snapshot/command-line-tools/commands/config/config-dump/) - Dump configuration