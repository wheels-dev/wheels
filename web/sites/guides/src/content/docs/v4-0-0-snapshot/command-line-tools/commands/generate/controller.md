---
title: wheels generate controller
---
...
- [wheels generate view](/v4-0-0-snapshot/command-line-tools/commands/generate/view/) - Generate views
- [wheels scaffold](/v4-0-0-snapshot/command-line-tools/commands/generate/scaffold/) - Generate complete CRUD
- [wheels generate test](/v4-0-0-snapshot/command-line-tools/commands/generate/test/) - Generate controller tests