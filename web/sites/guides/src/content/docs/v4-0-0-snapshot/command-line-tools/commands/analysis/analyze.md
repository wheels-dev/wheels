...
- [wheels analyze code](/v4-0-0-snapshot/command-line-tools/commands/analysis/analyze-code/) - Code quality analysis
- [wheels analyze performance](/v4-0-0-snapshot/command-line-tools/commands/analysis/analyze-performance/) - Performance analysis
- [wheels test run](/v4-0-0-snapshot/command-line-tools/commands/test/test-run/) - Run tests