...
- [Creating Commands](/v4-0-0-snapshot/command-line-tools/cli-guides/creating-commands/) - Build custom generators
- [Service Architecture](/v4-0-0-snapshot/command-line-tools/cli-guides/service-architecture/) - Understand the template service
- [wheels scaffold](/v4-0-0-snapshot/command-line-tools/commands/generate/scaffold/) - Main scaffold documentation