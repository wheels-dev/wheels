...
<Aside type="note">
  You should already know how [middleware](/v4-0-0-snapshot/core-concepts/middleware-pipeline/) and [views](/v4-0-0-snapshot/basics/views-layouts-partials/) work. Translation lookup runs in a view helper; locale detection runs in middleware.
</Aside>
...
Make sure locale-scoped routes come before `.wildcard()` — see [how route ordering works](/v4-0-0-snapshot/core-concepts/how-routing-works/).
