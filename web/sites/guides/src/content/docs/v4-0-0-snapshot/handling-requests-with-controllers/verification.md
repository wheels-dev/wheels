...
Now let's see how using the [verifies()](https://wheels.dev/api/v3.1.0/controller.verifies.html) function within Wheels improves this:
...
[verifies()](https://wheels.dev/api/v3.1.0/controller.verifies.html) exists solely to validate _controller_ and _environment level_ variables and is not a substitute for [Object Validation](https://wheels.dev/3.1.0/guides/database-interaction-through-models/object-validation)in your model.
