...
<CardGrid>
  ...
  <LinkCard title="Database and Multiple Datasources" href="/v4-0-0-snapshot/basics/database/" description="Configuring the connection migrations run against, and targeting a non-default datasource." />
</CardGrid>
