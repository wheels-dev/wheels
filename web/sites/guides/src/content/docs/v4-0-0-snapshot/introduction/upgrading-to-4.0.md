...
For the full picture of what is new in 4.0, see the [Wheels 4.0 Feature Audit](/v4-0-0-snapshot/introduction/https:/github.com/wheels-dev/wheels/blob/develop/docs/releases/wheels-4.0-audit/) (185-PR inventory) and the [3.0 → 4.0 Comparison](/v4-0-0-snapshot/introduction/https:/github.com/wheels-dev/wheels/blob/develop/docs/releases/wheels-3.0-vs-4.0/) (row-by-row breakdown of what changed).
...
- **WheelsTest (replacing RocketUnit).** Rewrite test specs in BDD style using `describe()` / `it()` / `expect()`. See [Testing Your Application](/v4-0-0-snapshot/working-with-wheels/testing-your-application/) for the migration mapping. Legacy RocketUnit specs continue to run.
...
- [Wheels 4.0 Feature Audit](/v4-0-0-snapshot/introduction/https:/github.com/wheels-dev/wheels/blob/develop/docs/releases/wheels-4.0-audit/) — every PR merged since 3.0.0, grouped by subsystem
- [3.0 → 4.0 Comparison](/v4-0-0-snapshot/introduction/https:/github.com/wheels-dev/wheels/blob/develop/docs/releases/wheels-3.0-vs-4.0/) — row-by-row breakdown of what changed
- [Legacy Compatibility Adapter README](/v4-0-0-snapshot/introduction/https:/github.com/wheels-dev/wheels/blob/develop/packages/legacyadapter/) — package docs
