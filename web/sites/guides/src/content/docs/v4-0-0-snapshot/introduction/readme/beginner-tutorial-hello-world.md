...
Let's make sure we're all on the same page. I'm going to assume that you've followed the [Getting Started](/v4-0-0-snapshot/) guide, installed the Wheels CLI via Homebrew or Chocolatey, and have Wheels set up. If you haven't done that, stop and read that guide to get everything installed. It's okay, this web page will wait for you.
