...
- [Packages](/v4-0-0-snapshot/digging-deeper/packages/) — the full lifecycle, the manifest schema, writing your own package, publishing to the registry.
