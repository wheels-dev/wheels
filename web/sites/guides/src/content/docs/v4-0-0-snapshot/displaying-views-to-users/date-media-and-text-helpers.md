---
title: Date, Media, and Text Helpers
description: >-
...
We also have separate chapters about Wheels form helpers in [Form Helpers and Showing Errors](https://wheels.dev/3.1.0/guides/displaying-views-to-users/form-helpers-and-showing-errors) and creating your own helpers in [Creating Custom View Helpers](https://wheels.dev/3.1.0/guides/displaying-views-to-users/creating-custom-view-helpers).
...
Instead of "April 27, 2009 10:10 pm," it may be more helpful to display "a few minutes ago" or "2 hours ago." This can be accomplished with a Wheels date helper called [timeAgoInWords()](https://wheels.dev/api/v3.1.0/controller.timeagoinwords.html).
...
First, to include CSS files in your layout, you can use the [styleSheetLinkTag()](https://wheels.dev/api/v3.1.0/controller.styleSheetLinkTag.html) function:
...
Including JavaScript files is just as simple with the [javaScriptIncludeTag()](https://wheels.dev/api/v3.1.0/controller.javascriptincludetag.html) helper. This time, files are referenced from the _**public/javascripts**_ folder.
...
Wheels's [imageTag()](https://wheels.dev/api/v3.1.0/controller.imagetag.html) helper also provides some simple, yet powerful functionality:
