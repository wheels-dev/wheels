...
{% hint style="info" %}
This guide covers the **native CFML browser testing** built into the Wheels framework. For the Node.js/TypeScript Playwright approach, see [End-to-End Testing](/v4-0-0-snapshot/working-with-wheels/end-to-end-testing/).
{% endhint %}
...
- [Testing Your Application](/v4-0-0-snapshot/working-with-wheels/testing-your-application/) — Unit and integration testing with WheelsTest
- [End-to-End Testing](/v4-0-0-snapshot/working-with-wheels/end-to-end-testing/) — Node.js/TypeScript Playwright approach
- [`wheels browser:install`](/v4-0-0-snapshot/command-line-tools/commands/browser/browser-install/) — CLI command reference
- [`wheels browser:test`](/v4-0-0-snapshot/command-line-tools/commands/browser/browser-test/) — CLI command reference
