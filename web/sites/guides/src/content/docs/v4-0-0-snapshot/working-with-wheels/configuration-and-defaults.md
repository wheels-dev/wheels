...
We all love the "Convention over Configuration" motto of Wheels, but what about those two cases that pop into everyone's head? _What if I want to develop in my own way?_ Or, _What about an existing application that I need to port into Wheels?_ Gladly, that's what configuration and defaults are there for. Let's take a look at exactly how this is performed.
...
You can also set values based on what environment you have set. For example, you can have different values for your settings depending on whether you're in `development` mode or `production` mode. See the chapter on [Switching Environments](/v4-0-0-snapshot/working-with-wheels/switching-environments/) for more details.
...
* [Environment settings](/v4-0-0-snapshot/working-with-wheels/configuration-and-defaults/#environment-settings)
* [URL rewriting settings](/v4-0-0-snapshot/working-with-wheels/configuration-and-defaults/#url-rewriting-settings)
* [Data source settings](/v4-0-0-snapshot/working-with-wheels/configuration-and-defaults/#data-source-settings)
* [Function settings](/v4-0-0-snapshot/working-with-wheels/configuration-and-defaults/#function-settings)
* [Debugging and error settings](/v4-0-0-snapshot/working-with-wheels/configuration-and-defaults/#debugging-and-error-settings)
* [Caching settings](/v4-0-0-snapshot/working-with-wheels/configuration-and-defaults/#caching-settings)
* [ORM settings](/v4-0-0-snapshot/working-with-wheels/configuration-and-defaults/#orm-settings)
* [Plugin settings](/v4-0-0-snapshot/working-with-wheels/configuration-and-defaults/#plugin-settings)
* [Media settings](/v4-0-0-snapshot/working-with-wheels/configuration-and-defaults/#media-settings)
* [Routing settings](/v4-0-0-snapshot/working-with-wheels/configuration-and-defaults/#routing-settings)
* [View helper settings](/v4-0-0-snapshot/working-with-wheels/configuration-and-defaults/#view-helper-settings)
* [CSRF protection settings](/v4-0-0-snapshot/working-with-wheels/configuration-and-defaults/#csrf-protection-settings)
* [Miscellaneous Settings](/v4-0-0-snapshot/working-with-wheels/configuration-and-defaults/#miscellaneous-settings)
* [Migrator settings](/v4-0-0-snapshot/working-with-wheels/configuration-and-defaults/#migrator-configuration-settings)
...
For more information, refer to the chapter about [Switching Environments](/v4-0-0-snapshot/working-with-wheels/switching-environments/).
...
For more information, refer to the chapter on [Caching](/v4-0-0-snapshot/handling-requests-with-controllers/caching/).
...
| showIncompatiblePlugins | boolean | false   | When set to true, an incompatibility warning will be displayed for plugins that do not specify the current Wheels version.                                                                                                                                 |
...
See the chapter about [Date, Media, and Text Helpers](/v4-0-0-snapshot/displaying-views-to-users/date-media-and-text-helpers/) for more information.
...
See the chapters about [Using Routes](https://wheels.dev/3.1.0/guides/handling-requests-with-controllers/routing) and [Obfuscating URLs](/v4-0-0-snapshot/handling-requests-with-controllers/obfuscating-urls/) for more information about how this all works together.
