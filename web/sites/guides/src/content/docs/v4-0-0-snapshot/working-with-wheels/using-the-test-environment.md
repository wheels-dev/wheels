...
After verifying that your changes pass all tests, you're ready to submit a pull request. For detailed instructions on the PR process, see [Submitting Pull Requests](/v4-0-0-snapshot/working-with-wheels/submitting-pull-requests/).