...
{% hint style="info" %}
This guide covers the **Node.js/TypeScript Playwright** approach. For native CFML browser testing that runs inside WheelsTest, see [Browser Testing](/v4-0-0-snapshot/working-with-wheels/browser-testing/).
{% endhint %}
...
- [Using the Test Environment](/v4-0-0-snapshot/working-with-wheels/using-the-test-environment/) - Docker-based test environment for framework testing
- [Request Handling](/v4-0-0-snapshot/working-with-wheels/handling-requests-with-controllers/request-handling/) - Understanding Wheels request lifecycle
