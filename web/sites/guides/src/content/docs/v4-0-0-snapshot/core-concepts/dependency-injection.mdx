...
- [Middleware Pipeline](/v4-0-0-snapshot/core-concepts/middleware-pipeline/) — also registered at boot
- [Controllers and Actions](/v4-0-0-snapshot/basics/controllers-and-actions/) — the hands-on `inject()` pattern
- [Tutorial Part 6b: Built-in Auth](/v4-0-0-snapshot/start-here/tutorial/06-authentication/) — canonical real usage
