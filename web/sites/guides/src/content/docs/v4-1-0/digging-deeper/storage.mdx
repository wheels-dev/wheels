...
<Aside type="note">
  You should already know the DI container basics (see [The Dependency Injection Container](/v4-1-0/core-concepts/dependency-injection/)) and have multipart uploads working (see [File Uploads & Downloads](/v4-1-0/digging-deeper/file-uploads-and-downloads/)). This page covers where the uploaded bytes go.
</Aside>
...
<CardGrid>
  <LinkCard title="File Uploads & Downloads" href="/v4-1-0/digging-deeper/file-uploads-and-downloads/" description="Multipart uploads, validation, and serving downloads safely." />
  <LinkCard title="The Dependency Injection Container" href="/v4-1-0/core-concepts/dependency-injection/" description="Why services.cfm, and how toFactory() fits construction with config." />
  <LinkCard title="Deployment: Secrets" href="/v4-1-0/deployment/secrets/" description="Keep accessKeyId / secretAccessKey out of source." />
</CardGrid>
