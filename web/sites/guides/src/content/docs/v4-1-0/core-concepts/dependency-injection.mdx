...
- [Middleware Pipeline](/v4-1-0/core-concepts/middleware-pipeline/) — also registered at boot
- [Controllers and Actions](/v4-1-0/basics/controllers-and-actions/) — the hands-on `inject()` pattern
- [Tutorial Part 6b: Built-in Auth](/v4-1-0/start-here/tutorial/06-authentication/) — canonical real usage
