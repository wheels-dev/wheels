...
<Aside type="note">
  This is the conceptual tour. The [Controllers and Actions](/v4-1-0/basics/controllers-and-actions/) page has the hands-on version — how to write an action step by step.
</Aside>
...
- [The Request Lifecycle](/v4-1-0/core-concepts/request-lifecycle/) — where each layer runs in the pipeline
- [ORM Philosophy](/v4-1-0/core-concepts/orm-philosophy/) — why ActiveRecord-style
- [Conventions over Configuration](/v4-1-0/core-concepts/conventions-over-configuration/) — the naming rules in depth
- [Controllers and Actions](/v4-1-0/basics/controllers-and-actions/) — the hands-on how-to
