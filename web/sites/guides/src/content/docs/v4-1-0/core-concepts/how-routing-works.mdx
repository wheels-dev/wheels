...
- [The Request Lifecycle](/v4-1-0/core-concepts/request-lifecycle/) — routing is the first stage of dispatch
- [Middleware Pipeline](/v4-1-0/core-concepts/middleware-pipeline/) — runs after the route is matched, before the controller
- [Routing](/v4-1-0/basics/routing/) — hands-on how-to
- [Controllers and Actions](/v4-1-0/basics/controllers-and-actions/) — where route params land
