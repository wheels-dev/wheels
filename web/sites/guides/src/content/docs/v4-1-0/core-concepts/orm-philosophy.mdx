...
- [MVC in Wheels](/v4-1-0/core-concepts/mvc-in-wheels/) — where the model layer sits
- [Models and the ORM](/v4-1-0/basics/models-and-the-orm/) — hands-on model authoring
- [Associations](/v4-1-0/basics/associations/) — modeling relationships
- [Query Builder and Scopes](/v4-1-0/basics/query-builder-and-scopes/) — efficient finders
