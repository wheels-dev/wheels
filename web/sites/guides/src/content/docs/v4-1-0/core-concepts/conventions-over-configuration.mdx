...
- [MVC in Wheels](/v4-1-0/core-concepts/mvc-in-wheels/) — the layer boundaries conventions glue together
- [How Routing Works](/v4-1-0/core-concepts/how-routing-works/) — the resource-to-routes convention
- [ORM Philosophy](/v4-1-0/core-concepts/orm-philosophy/) — ActiveRecord-style conventions
- [Models and the ORM](/v4-1-0/basics/models-and-the-orm/) — hands-on overrides
