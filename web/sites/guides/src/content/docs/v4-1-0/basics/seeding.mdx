...
<Aside type="note">
  You should already know how to define models and write migrations. See [Models and the ORM](/v4-1-0/basics/models-and-the-orm/) and [Migrations](/v4-1-0/basics/migrations/).
</Aside>
...
See [Fixtures & Test Data](/v4-1-0/testing/fixtures-and-test-data/) for the populate lifecycle and per-spec isolation patterns.

## Related guides

<CardGrid>
  <LinkCard title="Models and the ORM" href="/v4-1-0/basics/models-and-the-orm/" description="The finders and create() calls seedOnce() wraps for idempotency." />
  <LinkCard title="Migrations" href="/v4-1-0/basics/migrations/" description="Schema changes belong here, not in seeds — and vice versa." />
  <LinkCard title="Database and Multiple Datasources" href="/v4-1-0/basics/database-and-multiple-datasources/" description="Configuring the connection seeds run against." />
</CardGrid>
