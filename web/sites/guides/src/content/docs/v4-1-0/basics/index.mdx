...
<CardGrid>
  ...
  <LinkCard
    ...
    href="/v4-1-0/basics/validation-and-errors/"
  ...
  <LinkCard
    ...
    href="/v4-1-0/basics/query-builder-and-scopes/"
  ...
  <LinkCard
    ...
    href="/v4-1-0/basics/shared-development-databases/"
...
- [Start Here](/v4-1-0/start-here/) — install Wheels and build your first app with the tutorial
- [Core Concepts](/v4-1-0/core-concepts/) — the explanations behind what these guides show you how to do
- [Digging Deeper](/v4-1-0/digging-deeper/) — authentication, jobs, caching, uploads, and the rest of the advanced surface
