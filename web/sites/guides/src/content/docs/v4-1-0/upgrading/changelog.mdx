...
- [Upgrading Wheels](/v4-1-0/upgrading/) — versioning policy and release cadence
- [3.x to 4.x](/v4-1-0/upgrading/3x-to-4x/) — every breaking change in 4.0 with before/after examples
- [Release Channels](/v4-1-0/start-here/release-channels/) — stable vs bleeding-edge, and how to switch
