...
The audit log is on ephemeral `/tmp`, so it doesn't survive host reboots. For durable audit, pipe the log into your observability stack via a hook — see [Hooks](/v4-1-0/deployment/hooks/).
