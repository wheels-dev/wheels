...
<Aside type="danger">
All inbound traffic stops. Re-run [`proxy boot`](/v4-1-0/command-line-tools/commands/deploy/proxy/boot/) or [`wheels deploy setup`](/v4-1-0/command-line-tools/commands/deploy/setup/) to restore.
</Aside>
