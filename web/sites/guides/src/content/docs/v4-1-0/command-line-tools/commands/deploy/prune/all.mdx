...
Runs [`prune containers`](/v4-1-0/command-line-tools/commands/deploy/prune/containers/) then [`prune images`](/v4-1-0/command-line-tools/commands/deploy/prune/images/) on every host. The current live container and everything in the retention window survives.
