...
| Verb | Removes |
|------|---------|
| [`all`](/v4-1-0/command-line-tools/commands/deploy/prune/all/) | Old containers + old images. |
| [`images`](/v4-1-0/command-line-tools/commands/deploy/prune/images/) | Old images only. |
| [`containers`](/v4-1-0/command-line-tools/commands/deploy/prune/containers/) | Old containers only. |
