...
For a broader sweep that shows every service-labelled container regardless of version, use [`app containers`](/v4-1-0/command-line-tools/commands/deploy/app/containers/) instead.
