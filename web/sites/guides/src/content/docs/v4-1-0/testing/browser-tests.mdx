...
<Aside type="note">
  You should already know BDD basics. See [Model Tests](/v4-1-0/testing/model-tests/). For non-browser HTTP tests that don't need JavaScript or Turbo, prefer [Controller Tests](/v4-1-0/testing/controller-tests/), [Functional Tests](/v4-1-0/testing/functional-tests/), or [View & Form Tests](/v4-1-0/testing/view-and-form-tests/).
</Aside>
...
See [View & Form Tests](/v4-1-0/testing/view-and-form-tests/) for the same `data-auto-id` pattern applied to non-browser tests, and [Forms and Form Helpers](/v4-1-0/basics/forms-and-form-helpers/) for how the attribute is generated.
...
For local work against a non-8080 server (Titan on 60050, `wheels new` scaffolds on 60080), CGI auto-detect picks up the correct host and port automatically. See [CI Integration](/v4-1-0/testing/ci-integration/) for the full workflow.
...
- Server-rendered HTML, redirects, status codes → [Controller Tests](/v4-1-0/testing/controller-tests/)
- Rendered markup without JS → [View & Form Tests](/v4-1-0/testing/view-and-form-tests/)
- Multi-controller flows without UI assertions → [Functional Tests](/v4-1-0/testing/functional-tests/)
- Model behavior → [Model Tests](/v4-1-0/testing/model-tests/)
...
<CardGrid>
  ...
  <LinkCard
    ...
    href="/v4-1-0/basics/forms-and-form-helpers/"
