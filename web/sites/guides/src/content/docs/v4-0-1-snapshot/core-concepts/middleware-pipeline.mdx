...
- [The Request Lifecycle](/v4-0-1-snapshot/core-concepts/request-lifecycle/) — where in the pipeline middleware sits
- [How Routing Works](/v4-0-1-snapshot/core-concepts/how-routing-works/) — route-scoped middleware comes from here
- [Rate Limiting](/v4-0-1-snapshot/digging-deeper/) — built-in rate limiter in depth (Phase 2b target)
- [CORS](/v4-0-1-snapshot/digging-deeper/) — CORS configuration deep-dive (Phase 2b target)
