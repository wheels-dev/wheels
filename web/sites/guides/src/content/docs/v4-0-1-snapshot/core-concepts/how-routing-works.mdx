...
- [The Request Lifecycle](/v4-0-1-snapshot/core-concepts/request-lifecycle/) — routing is stage 2
- [Middleware Pipeline](/v4-0-1-snapshot/core-concepts/middleware-pipeline/) — runs before the router
- [Routing](/v4-0-1-snapshot/basics/routing/) — hands-on how-to
- [Controllers and Actions](/v4-0-1-snapshot/basics/controllers-and-actions/) — where route params land
