...
You've read [Your First Deploy](/v4-0-1-snapshot/deployment/first-deploy/) and understand the shape of a working deploy. This page is the dry reference — no narrative, just the schema.
</Aside>
...
See [Accessories](/v4-0-1-snapshot/deployment/accessories/) for the full walk-through.
...
See [Hooks](/v4-0-1-snapshot/deployment/hooks/) for what the scripts look like.
