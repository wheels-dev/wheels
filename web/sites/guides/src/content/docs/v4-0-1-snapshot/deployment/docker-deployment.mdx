...
<Aside type="note">
  You should already know how a Wheels app is laid out and how datasources are configured at boot. See [Environments and Configuration](/v4-0-1-snapshot/core-concepts/environments-and-configuration/) if either of those is still fuzzy.
</Aside>
