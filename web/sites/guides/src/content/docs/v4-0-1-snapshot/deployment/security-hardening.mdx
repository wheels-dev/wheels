...
<Aside type="note">
  You should already know how the middleware pipeline runs. See [Middleware Pipeline](/v4-0-1-snapshot/core-concepts/middleware-pipeline/).
</Aside>
