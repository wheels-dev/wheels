...
The scaffold gives you CRUD, not a login flow. See [Authentication Patterns](/v4-0-1-snapshot/digging-deeper/authentication-patterns/) for cookbook-style recipes — session-based, token-based, and third-party OAuth — that drop onto the scaffold you just generated.
