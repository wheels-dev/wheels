...
Alias for [`registry login`](/v4-0-1-snapshot/command-line-tools/commands/deploy/registry/login/). Kept for parity with Kamal's setup verb.
...
Behavior identical to [`registry login`](/v4-0-1-snapshot/command-line-tools/commands/deploy/registry/login/).
