...
For a broader sweep that shows every service-labelled container regardless of version, use [`app containers`](/v4-0-1-snapshot/command-line-tools/commands/deploy/app/containers/) instead.
