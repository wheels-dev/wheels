...
Install and run the `kamal-proxy` singleton on every host. First-run verb — pair with [`setup`](/v4-0-1-snapshot/command-line-tools/commands/deploy/setup/) which calls this automatically.
