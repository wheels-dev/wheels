...
- [Packages](/v4-0-1-snapshot/digging-deeper/packages/) — the full lifecycle, the manifest schema, writing your own package, publishing to the registry.
