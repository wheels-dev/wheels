...
The validation API you just used is documented in full at [Validation and Error Display](/v4-0-1-snapshot/basics/validation-and-errors/). The form helpers (including the `data-auto-id` attribute for test selectors) are covered in [Forms and Form Helpers](/v4-0-1-snapshot/basics/forms-and-form-helpers/).
