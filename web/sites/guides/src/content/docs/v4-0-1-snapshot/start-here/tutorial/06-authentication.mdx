...
The DI container you used to wire `SessionStrategy` in 6b is a core framework feature. See [The Dependency Injection Container](/v4-0-1-snapshot/core-concepts/dependency-injection/) for when to reach for it vs plain `new SomeClass()`.
