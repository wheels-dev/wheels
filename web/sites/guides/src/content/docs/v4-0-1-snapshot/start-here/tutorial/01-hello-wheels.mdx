...
<Aside type="note">
  This is Part 1 of the [Build a Blog tutorial](/v4-0-1-snapshot/start-here/tutorial/). You don't need Wheels or CFML experience — just general programming background.
</Aside>
...
If you haven't yet, see [Installing Wheels](/v4-0-1-snapshot/start-here/installing/) for macOS, Windows, and Linux.
...
<Aside type="tip" title="Already installed? Make sure you're on the latest snapshot.">
  ...
  - **Windows / other:** see [Installing → Upgrading](/v4-0-1-snapshot/start-here/installing/#upgrading)
...
**`wheels: command not found`** — PATH doesn't see the CLI. See [Installing Wheels](/v4-0-1-snapshot/start-here/installing/).
...
In [Part 2](/v4-0-1-snapshot/start-here/tutorial/02-first-model/) you'll add your first model, write a migration, and seed real data. The browser-render-a-page part is done; now you meet the database.
