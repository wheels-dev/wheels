...
That's enough vocabulary to cover the first hundred specs you'll write. See [Testing](/v4-0-1-snapshot/testing/) for the full matcher list.
...
The `--filter` flag narrows the run to specs whose path contains the argument. Other filters accept `models`, `controllers`, or a full directory path. The exact syntax is still settling; see [CLI Reference](/v4-0-1-snapshot/command-line-tools/) for the current options.
...
<CardGrid>
  <LinkCard title="Bonus: Style with wheels-basecoat" href="/v4-0-1-snapshot/start-here/tutorial/08-bonus-basecoat/" description="Optional 30-min chapter. Install your first package and rewrite the post view with shadcn/ui-quality components." />
  <LinkCard title="Core Concepts" href="/v4-0-1-snapshot/core-concepts/" description="Request lifecycle, MVC, ORM philosophy, DI container, middleware pipeline." />
  <LinkCard title="Digging Deeper" href="/v4-0-1-snapshot/digging-deeper/" description="Background jobs, email, file uploads, caching, multi-tenancy, packages, SSE." />
  <LinkCard title="Testing" href="/v4-0-1-snapshot/testing/" description="Full WheelsTest patterns, more browser tests, CI setup, fixtures." />
  <LinkCard title="CLI Reference" href="/v4-0-1-snapshot/command-line-tools/" description="Every wheels command." />
</CardGrid>
