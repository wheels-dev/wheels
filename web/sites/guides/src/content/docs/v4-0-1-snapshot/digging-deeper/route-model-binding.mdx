...
<Aside type="note">
  You should already know how routes map to actions. See [How Routing Works](/v4-0-1-snapshot/core-concepts/how-routing-works/) for the match algorithm and [Routing](/v4-0-1-snapshot/basics/routing/) for the `.resources()` DSL.
</Aside>
...
<CardGrid>
  <LinkCard title="How Routing Works" href="/v4-0-1-snapshot/core-concepts/how-routing-works/" description="The match algorithm, resource expansion, and where route model binding sits in the dispatch pipeline." />
  <LinkCard title="Routing" href="/v4-0-1-snapshot/basics/routing/" description="The .resources() DSL, nested and scoped routes, and where binding=true lives in practice." />
  <LinkCard title="Controllers and Actions" href="/v4-0-1-snapshot/basics/controllers-and-actions/" description="Action patterns, filters, and why binding reduces the boilerplate at the top of member actions." />
  <LinkCard title="Authorization & Filters" href="/v4-0-1-snapshot/digging-deeper/authorization-and-filters/" description="Ownership checks and policy filters that run against the record binding resolved for you." />
</CardGrid>
