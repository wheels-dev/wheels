...
<Aside type="note">
  You should already know how to define models and write migrations. See [Models and the ORM](/v4-0-1-snapshot/basics/models-and-the-orm/) and [Migrations](/v4-0-1-snapshot/basics/migrations/).
</Aside>
...
Testing content lands in Phase 2b; until then, see the stub at [Testing](/v4-0-1-snapshot/testing/).

## Related guides

<CardGrid>
  <LinkCard title="Models and the ORM" href="/v4-0-1-snapshot/basics/models-and-the-orm/" description="The finders and create() calls seedOnce() wraps for idempotency." />
  <LinkCard title="Migrations" href="/v4-0-1-snapshot/basics/migrations/" description="Schema changes belong here, not in seeds — and vice versa." />
  <LinkCard title="Database and Multiple Datasources" href="/v4-0-1-snapshot/basics/database-and-multiple-datasources/" description="Configuring the connection seeds run against." />
</CardGrid>
