...
<Aside type="note">
  You should already know why validations live on the model. See [ORM Philosophy](/v4-0-1-snapshot/core-concepts/orm-philosophy/).
</Aside>
...
The argument is the view-scope variable name — `"post"` here matches `posts` in the `new` action. See [Forms and Form Helpers](/v4-0-1-snapshot/basics/forms-and-form-helpers/) for the wider form flow this slots into.
...
<CardGrid>
  <LinkCard title="Forms and Form Helpers" href="/v4-0-1-snapshot/basics/forms-and-form-helpers/" description="The object-bound form helpers that pair with errorMessagesFor." />
  <LinkCard title="Controllers and Actions" href="/v4-0-1-snapshot/basics/controllers-and-actions/" description="The create / update flow that triggers validations." />
  <LinkCard title="ORM Philosophy" href="/v4-0-1-snapshot/core-concepts/orm-philosophy/" description="Why validations live on the model, not the controller." />
</CardGrid>
