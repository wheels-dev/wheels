...
<Aside type="note">
  You should already know how to define models. See [Models and the ORM](/v4-0-1-snapshot/basics/models-and-the-orm/).
</Aside>
...
For queries that return model instances rather than a raw query result, stay with `findAll(where="...")` or the [query builder](/v4-0-1-snapshot/basics/query-builder-and-scopes/). Raw `queryExecute()` is for the cases where you genuinely want a query object, not an array of objects.
...
<CardGrid>
  <LinkCard title="Models and the ORM" href="/v4-0-1-snapshot/basics/models-and-the-orm/" description="Defining a model, finders, persistence, and the non-convention overrides this page extends." />
  <LinkCard title="Query Builder and Scopes" href="/v4-0-1-snapshot/basics/query-builder-and-scopes/" description="Chainable queries, reusable scopes, enums, and batch processing — the safe alternative to raw SQL." />
  <LinkCard title="Migrations" href="/v4-0-1-snapshot/basics/migrations/" description="Schema changes, column types, and indexes. The table structure your datasource exposes." />
  <LinkCard title="Environments and Configuration" href="/v4-0-1-snapshot/core-concepts/environments-and-configuration/" description="The configuration loading order. Datasource settings usually differ per environment." />
</CardGrid>
