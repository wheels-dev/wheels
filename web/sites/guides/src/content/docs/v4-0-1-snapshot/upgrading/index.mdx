...
<Aside type="note">
  `CHANGELOG.md` lives at the repository root and is not bundled inside `vendor/wheels/`. If you work with a vendored copy of the framework and cannot reach GitHub, see [Reading the Changelog](/v4-0-1-snapshot/upgrading/changelog/) for how to access it offline.
</Aside>
...
<CardGrid>
  <LinkCard
    ...
    href="/v4-0-1-snapshot/upgrading/3x-to-4x/"
  />
  <LinkCard
    title="2.x to 3.x"
    ...
    href="/v4-0-1-snapshot/upgrading/2x-to-3x/"
  />
  <LinkCard
    title="Reading the Changelog"
    description="Where CHANGELOG.md lives, how to look up PR references cited in upgrade guides, and how to access it when working with a vendored copy offline."
    href="/v4-0-1-snapshot/upgrading/changelog/"
  />
</CardGrid>
