...
<Aside type="note">
  You should already know what a spec looks like. See [Model Tests](/v4-0-1-snapshot/testing/model-tests/) for BDD shape and [Fixtures & Test Data](/v4-0-1-snapshot/testing/fixtures-and-test-data/) for the populate lifecycle.
</Aside>
...
<CardGrid>
  ...
  <LinkCard title="Browser Tests" href="/v4-0-1-snapshot/testing/browser-tests/" description="Installing Playwright and running browser specs locally." />
