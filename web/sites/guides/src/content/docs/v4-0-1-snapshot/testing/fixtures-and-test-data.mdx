...
<Aside type="note">
  You should already know BDD basics. See [Model Tests](/v4-0-1-snapshot/testing/model-tests/) for the spec shape. This page covers the fixture plumbing every test type relies on.
</Aside>
...
<CardGrid>
  <LinkCard title="Model Tests" href="/v4-0-1-snapshot/testing/model-tests/" description="BDD specs for validations, callbacks, scopes, and associations." />
  <LinkCard title="Controller Tests" href="/v4-0-1-snapshot/testing/controller-tests/" description="TestClient HTTP patterns — response assertions, redirects, filters, session handling." />
  <LinkCard title="Integration Tests" href="/v4-0-1-snapshot/testing/integration-tests/" description="Multi-request journeys across your stack — login, create, redirect." />
  <LinkCard title="Running Tests Locally" href="/v4-0-1-snapshot/testing/running-tests-locally/" description="LuCLI test runner, Docker matrix, common test commands." />
</CardGrid>
