...
| [7. Testing and Deploying](/v4-0-0-snapshot/start-here/tutorial/07-testing-deploying/) | Model spec, controller spec, one browser spec. Deployment overview. What to read next. | 35 min |
| [Bonus: Style with wheels-basecoat](/v4-0-0-snapshot/start-here/tutorial/08-bonus-basecoat/) | Optional. Install the basecoat package and convert the post view to shadcn/ui-quality components. Meets the Wheels package system end-to-end. | 30 min |
...
<CardGrid>
  ...
  <LinkCard
    ...
    href="/v4-0-0-snapshot/start-here/tutorial/07-testing-deploying/"
    description="35 minutes — WheelsTest, browser tests, deployment"
  />
  <LinkCard
    title="Bonus: Style with wheels-basecoat"
    href="/v4-0-0-snapshot/start-here/tutorial/08-bonus-basecoat/"
