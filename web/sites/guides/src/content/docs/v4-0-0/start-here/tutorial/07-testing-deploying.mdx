...
The `--filter` flag narrows the run to specs whose path contains the argument — `models`, `controllers`, or a full directory path all work. See [Running Tests Locally](/v4-0-0/testing/running-tests-locally/) for the full flag surface.
