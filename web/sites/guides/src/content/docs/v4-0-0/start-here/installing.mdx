...
Also supported: [Manual Installation](/v4-0-0/start-here/manual-installation/) gets you running from two zip downloads with zero dependencies, and [Working Without the CLI](/v4-0-0/start-here/working-without-the-cli/) maps every CLI task to its in-framework equivalent. Unsure which path fits? [Choosing Your Tooling](/v4-0-0/start-here/choosing-your-tooling/) settles it in one page.
</Aside>
