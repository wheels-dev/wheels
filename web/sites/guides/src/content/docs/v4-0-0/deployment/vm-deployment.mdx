...
Wheels reads these at boot via `env("VAR_NAME")`. See [Environments and Configuration](/v4-0-0/core-concepts/environments-and-configuration/#secrets-handling) for where that lookup happens.
