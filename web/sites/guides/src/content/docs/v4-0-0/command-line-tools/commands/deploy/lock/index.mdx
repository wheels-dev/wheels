...
| Verb | Purpose |
|------|---------|
| [`acquire`](/v4-0-0/command-line-tools/commands/deploy/lock/acquire/) | Manually take the lock. |
| [`release`](/v4-0-0/command-line-tools/commands/deploy/lock/release/) | Manually release the lock. |
| [`status`](/v4-0-0/command-line-tools/commands/deploy/lock/status/) | Report whether the lock is held and who holds it. |
