...
Assumes the image is already pushed — use [`build push`](/v4-0-0/command-line-tools/commands/deploy/build/push/) first, or [`build deliver`](/v4-0-0/command-line-tools/commands/deploy/build/deliver/) for both.
