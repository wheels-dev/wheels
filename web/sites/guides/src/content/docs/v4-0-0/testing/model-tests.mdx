...
<Aside type="note">
  You should already know how to define a model. See [Models and the ORM](/v4-0-0-snapshot/basics/models-and-the-orm/). For the BDD basics — where specs live, how the runner boots — see [Testing](/v4-0-0-snapshot/testing/).
</Aside>
...
<CardGrid>
  <LinkCard title="Models and the ORM" href="/v4-0-0-snapshot/basics/models-and-the-orm/" description="Defining models, declaring config(), finders and creators." />
  <LinkCard title="Validation and Error Display" href="/v4-0-0-snapshot/basics/validation-and-errors/" description="The validation helpers you're testing — presence, length, uniqueness, format." />
  <LinkCard title="Associations" href="/v4-0-0-snapshot/basics/associations/" description="hasMany, belongsTo, dependent=delete, and the association methods your specs exercise." />
  <LinkCard title="Query Builder and Scopes" href="/v4-0-0-snapshot/basics/query-builder-and-scopes/" description="Named scopes, dynamic scopes, and enum-generated scopes." />
</CardGrid>
