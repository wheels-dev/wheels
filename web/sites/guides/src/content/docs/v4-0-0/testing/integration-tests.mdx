...
<Aside type="note">
  You should already know BDD basics and the `TestClient` API. See [Model Tests](/v4-0-0-snapshot/testing/model-tests/) and [Controller Tests](/v4-0-0-snapshot/testing/controller-tests/).
</Aside>
...
<CardGrid>
  ...
  <LinkCard title="View & Form Tests" href="/v4-0-0-snapshot/testing/view-and-form-tests/" description="Rendering partials, form helper output, and error display." />
  <LinkCard title="Models and the ORM" href="/v4-0-0-snapshot/basics/models-and-the-orm/" description="Finders, associations, and the persistence APIs your integration tests assert against." />
</CardGrid>
