...
<Aside type="note">
  You should already know how to run tests locally. See [Running Tests Locally](/v4-0-0-snapshot/testing/running-tests-locally/) for `wheels test`, `tools/test-local.sh`, and the Docker Compose map of ports and databases.
</Aside>
...
<CardGrid>
  <LinkCard title="Running Tests Locally" href="/v4-0-0-snapshot/testing/running-tests-locally/" description="The fast path with wheels test and tools/test-local.sh, plus the Docker cross-engine matrix." />
