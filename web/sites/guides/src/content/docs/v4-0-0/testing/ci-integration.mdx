...
# Parse totals and surface any scope warnings (rejected directory, 0-bundle discovery)
python3 -c "
import json, sys
...
if d.get('directoryRejected'):
    print('ERROR: directory= was rejected; ran the full suite instead', file=sys.stderr)
    sys.exit(1)
