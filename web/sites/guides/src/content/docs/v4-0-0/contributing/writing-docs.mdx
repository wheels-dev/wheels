...
<Aside type="note">
  You should already be comfortable with Markdown and MDX. If you haven't opened a Wheels PR before, start with [Pull Requests](/v4-0-0-snapshot/contributing/pull-requests/). Security issues follow a different path — see the disclosure note on the [Contributing index](/v4-0-0-snapshot/contributing/).
</Aside>
...
3. **Run the harness against your page.**
   ...
   pnpm verify:docs src/content/docs/v4-0-0-snapshot/contributing/writing-docs.mdx
   ```
...
<CardGrid>
  <LinkCard title="Pull Requests" href="/v4-0-0-snapshot/contributing/pull-requests/" description="Fork-and-pull workflow, branch naming, definition of done, and the review loop." />
  <LinkCard title="Coding Standards" href="/v4-0-0-snapshot/contributing/coding-standards/" description="Formatting rules, commit-message scopes, and the cross-engine gotchas to avoid." />
  <LinkCard title="Contributing & Project" href="/v4-0-0-snapshot/contributing/" description="How the project is run, who the core team is, and the four ways you can help." />
  <LinkCard title="Running Tests Locally" href="/v4-0-0-snapshot/testing/running-tests-locally/" description="A howto built in this style — a good reference when you're shaping your own." />
</CardGrid>
