...
<Aside type="note">
  You should already be comfortable with CFML components and Wheels' model/controller basics. If you're about to edit `vendor/wheels/`, skim [Cross-engine compatibility](/v4-0-0/troubleshooting/cross-engine-compatibility/) alongside this page.
</Aside>
