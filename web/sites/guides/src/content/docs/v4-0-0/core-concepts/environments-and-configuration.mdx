...
- `config/services.cfm` — DI container registrations. See [The Dependency Injection Container](/v4-0-0-snapshot/core-concepts/dependency-injection/).
- `config/routes.cfm` — route definitions. See [How Routing Works](/v4-0-0-snapshot/core-concepts/how-routing-works/).
...
- [The Dependency Injection Container](/v4-0-0-snapshot/core-concepts/dependency-injection/) — also loaded at boot
- [Installing Wheels](/v4-0-0-snapshot/start-here/installing/) — environment-variable setup
- [Deployment Overview](/v4-0-0-snapshot/deployment/) — environment per deploy target
