...
- `dataSource("legacy_db")` — non-default datasource. See [Database and Multiple Datasources](/v4-0-0/basics/database-and-multiple-datasources/) for the wider multi-database story.
