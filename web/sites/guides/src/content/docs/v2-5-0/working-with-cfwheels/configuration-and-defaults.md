...
You can also set values based on what environment you have set. For example, you can have different values for your settings depending on whether you're in `development` mode or `production` mode. See the chapter on [Switching Environments](/v2-5-0/working-with-cfwheels/switching-environments/) for more details.
...
For more information, refer to the chapter about [Switching Environments](/v2-5-0/working-with-cfwheels/switching-environments/).
...
For more information, refer to the chapter on [Caching](/v2-5-0/handling-requests-with-controllers/caching/).
...
See the chapter about [Date, Media, and Text Helpers](/v2-5-0/displaying-views-to-users/date-media-and-text-helpers/) for more information.
...
See the chapters about [Using Routes](/2.5.0/guides/handling-requests-with-controllers/routing) and [Obfuscating URLs](/v2-5-0/handling-requests-with-controllers/obfuscating-urls/) for more information about how this all works together.
