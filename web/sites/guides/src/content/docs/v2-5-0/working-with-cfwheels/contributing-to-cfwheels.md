---
title: Contributing to CFWheels
description: >-
...
8. If needed, open an issue to have the additions and changes in your revision documented in the [CHANGELOG](/v2-5-0/working-with-cfwheels/https:/github.com/cfwheels/cfwheels/blob/main/CHANGELOG/). You may claim the issue if you'd like to do this, but it's entirely your choice.

## Developing with Docker

To easily develop and test CFWheels locally on multiple CFML engines using Docker, check out the [Docker Instructions](/v2-5-0/working-with-cfwheels/https:/github.com/wheels-dev/wheels/blob/main/docker/)
