...
If you use Tomcat and Tuckey, or CommandBox [URL Rewriting](/2.5.0/guides/handling-requests-with-controllers/url-rewriting/README), you'll need this file. Otherwise, you can safely delete it. No longer included by default in 2.x
