...
<pre><code class='javascript'>// Specify that instances of this model has one profile. (The table for the associated model, not the current, should have the foreign key set on it.)
hasOne(&quot;profile&quot;);
