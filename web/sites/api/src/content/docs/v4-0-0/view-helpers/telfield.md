---
title: telField()
description: "Builds and returns a string containing a telephone field form control based on the supplied objectName and property."
sidebar:
  label: telField()
  order: 0
---
