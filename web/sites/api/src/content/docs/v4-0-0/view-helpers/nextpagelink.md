---
title: nextPageLink()
description: "Creates a link to the next page, or a disabled span when on the last page."
sidebar:
  label: nextPageLink()
  order: 0
---
...
| ---- | ---- | -------- | ------- | ----------- |
| `text` | `string` | no | `Next` | The text for the link. |
...
| `showDisabled` | `boolean` | no | `true` | Whether to render a disabled span when on the last page. |
