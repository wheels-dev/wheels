...
description: "Tells CFWheels to protect <code>POST</code>ed requests from CSRF vulnerabilities."
sidebar:
...
Tells CFWheels to protect <code>POST</code>ed requests from CSRF vulnerabilities.
