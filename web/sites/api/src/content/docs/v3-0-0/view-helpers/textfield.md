---
title: textField()
description: "Builds and returns an HTML text field form control that is bound to a model object and one of its properties. By default, it will populate the value of the fiel"
sidebar:
  label: textField()
  order: 0
---
...
<pre><code class='javascript'>1. Basic text field with label
