---
title: setPagination()
description: "Aallows you to define a pagination handle for a custom query so that you can easily generate paginated links and manage page offsets in your views. It’s useful"
sidebar:
  label: setPagination()
  order: 0
---
