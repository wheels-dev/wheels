---
title: create()
description: "The create() method is used to instantiate a new model object, set its properties, and save it to the database (if validations pass). Even if validation fails,"
sidebar:
  label: create()
  order: 0
---
...
anOrder = aCustomer.createOrder(shipping=params.shipping);</code></pre>
