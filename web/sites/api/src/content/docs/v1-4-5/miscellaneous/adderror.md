...
<pre>addError(property, message [, name ]) &lt;!--- Add an error to the `email` property ---&gt;
&lt;cfset this.addError(property=&quot;email&quot;, message=&quot;Sorry, you are not allowed to use that email. Try again, please.&quot;)&gt;</pre>
