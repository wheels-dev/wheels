---
title: contentFor()
description: "Used to store a section's output for rendering within a layout. This content store acts as a stack, so you can store multiple pieces of content for a given sect"
sidebar:
  label: contentFor()
  order: 0
---
