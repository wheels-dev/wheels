...
<pre><code class='javascript'>&lt;!--- Basic usage usually involves a `label`, `name`, and `password` ---&gt;
#textAreaTag(label=&quot;Description&quot;, name=&quot;description&quot;, content=params.description)#</code></pre>
