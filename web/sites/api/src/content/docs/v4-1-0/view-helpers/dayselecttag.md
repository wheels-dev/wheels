---
title: daySelectTag()
description: "Builds and returns a string containing a <code>select</code> form control for the days of the month based on the supplied name."
sidebar:
  label: daySelectTag()
  order: 0
---
...
Builds and returns a string containing a <code>select</code> form control for the days of the month based on the supplied name.
...
<pre><code class='javascript'>// 1. Basic usage: render a day-of-month select for a standalone form (not bound to a model)
