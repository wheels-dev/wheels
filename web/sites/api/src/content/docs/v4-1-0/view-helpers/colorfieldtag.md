---
title: colorFieldTag()
description: "Builds and returns a string containing a color picker form control based on the supplied name."
sidebar:
  label: colorFieldTag()
  order: 0
---
...
<pre><code class='javascript'>// 1. Basic color picker with a default value
