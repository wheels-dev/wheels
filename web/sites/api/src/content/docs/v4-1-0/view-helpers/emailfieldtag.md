---
title: emailFieldTag()
description: "Builds and returns a string containing an email field form control based on the supplied name."
sidebar:
  label: emailFieldTag()
  order: 0
---
...
<pre><code class='javascript'>// 1. Basic email field with a name and pre-filled value
