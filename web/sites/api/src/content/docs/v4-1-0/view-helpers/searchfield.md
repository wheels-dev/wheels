---
title: searchField()
description: "Builds and returns a string containing a search field form control based on the supplied objectName and property."
sidebar:
  label: searchField()
  order: 0
---
...
<pre><code class='javascript'>// 1. Basic search field bound to a model object
