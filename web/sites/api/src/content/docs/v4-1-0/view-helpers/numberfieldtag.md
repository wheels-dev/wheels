---
title: numberFieldTag()
description: "Builds and returns a string containing a number field form control based on the supplied name."
sidebar:
  label: numberFieldTag()
  order: 0
---

## Signature

`numberFieldTag()` — returns `string`
...
<pre><code class='javascript'>// 1. Basic number field with a name and current value
