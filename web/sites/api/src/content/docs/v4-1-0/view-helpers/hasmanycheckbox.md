...
| `id` | `string` | no | — | Optional. Explicit ID for the generated checkbox input. If not provided, an ID will be generated automatically. |

</div>

## Examples

<pre><code class='javascript'>// 1. Show check boxes for associating authors with the current book
