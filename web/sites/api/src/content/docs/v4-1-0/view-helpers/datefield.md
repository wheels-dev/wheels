---
title: dateField()
description: "Builds and returns a string containing a date field form control based on the supplied objectName and property."
sidebar:
  label: dateField()
  order: 0
---
...
<pre><code class='javascript'>// 1. Basic date field bound to a model object property
