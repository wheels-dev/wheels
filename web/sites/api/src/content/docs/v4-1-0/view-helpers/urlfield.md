---
title: urlField()
description: "Builds and returns a string containing a URL field form control based on the supplied objectName and property."
sidebar:
  label: urlField()
  order: 0
---
...
<pre><code class='javascript'>// 1. Basic URL field bound to an object property
