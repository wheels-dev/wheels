---
title: emailField()
description: "Builds and returns a string containing an email field form control based on the supplied objectName and property."
sidebar:
  label: emailField()
  order: 0
---
...
<pre><code class='javascript'>// 1. Basic email field bound to an object property
