---
title: colorField()
description: "Builds and returns a string containing a color picker form control based on the supplied objectName and property."
sidebar:
  label: colorField()
  order: 0
---
...
<pre><code class='javascript'>// 1. Basic color picker bound to a model object property
