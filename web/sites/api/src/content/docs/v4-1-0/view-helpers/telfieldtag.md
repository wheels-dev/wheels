---
title: telFieldTag()
description: "Builds and returns a string containing a telephone field form control based on the supplied name."
sidebar:
  label: telFieldTag()
  order: 0
---
...
<pre><code class='javascript'>// 1. Basic telephone field with a pre-filled value
