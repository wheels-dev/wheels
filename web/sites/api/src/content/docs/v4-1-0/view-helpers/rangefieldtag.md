---
title: rangeFieldTag()
description: "Builds and returns a string containing a range slider form control based on the supplied name."
sidebar:
  label: rangeFieldTag()
  order: 0
---
...
<pre><code class='javascript'>// 1. Basic range slider with a name and current value
