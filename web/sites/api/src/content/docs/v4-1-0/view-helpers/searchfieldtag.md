---
title: searchFieldTag()
description: "Builds and returns a string containing a search field form control based on the supplied name."
sidebar:
  label: searchFieldTag()
  order: 0
---

## Signature

`searchFieldTag()` — returns `string`
...
<pre><code class='javascript'>// 1. Basic search field with a label and pre-populated value
...
#searchFieldTag(name=&quot;q&quot;, value=params.q)#</code></pre>
