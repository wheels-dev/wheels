---
title: urlFieldTag()
description: "Builds and returns a string containing a URL field form control based on the supplied name."
sidebar:
  label: urlFieldTag()
  order: 0
---
...
<pre><code class='javascript'>// 1. Basic URL field with a label
