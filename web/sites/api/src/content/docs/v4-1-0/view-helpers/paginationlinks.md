...
| `addActiveClassToPrependedParent` | `boolean` | no | `false` | Whether or not to add an active class to the parent element of the current page link (requires prependToPage to contain a class attribute). |
