...
<pre><code class='javascript'>// This will only provide the `html` type and will ignore what was defined in the call to `provides()` in the `config()` function
onlyProvides(&quot;html&quot;);</code></pre>
