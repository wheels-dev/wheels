...
<pre><code class='javascript'>// Get the amount of the lowest salary for all employees
...
lowestSalary = model(&quot;employee&quot;).minimum(property=&quot;salary&quot;, where=&quot;salary BETWEEN #params.min# AND #params.max#&quot;, ifNull=0);</code></pre>
