...
<pre>// Get the name of the primary key of the table mapped to the `employee` model (which is the `employees` table by default)
keyName = model(&quot;employee&quot;).primaryKey();</pre>
