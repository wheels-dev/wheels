...
categories: []
excerpt: >-
  For years, the same rows showed up red in every framework comparison: no
  bulk ops, no polymorphic associations, no advisory locks, no middleware, no
  browser testing. Wheels 4.0 closes those gaps. This is a guided tour of what
  changed and where the framework still trails.
coverImage: null
---
