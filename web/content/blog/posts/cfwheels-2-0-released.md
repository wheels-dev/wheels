...
3.  Commandbox install wizard via CFWheels CLI (with url rewriting included):  `wheels new` *(make sure your version of the CLI is up to date with* `_install cfwheels-cli_`_)_
