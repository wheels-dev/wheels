...
- The API server uses `-f /wheels-test-suite/compose.yml` to specify the compose file
- Make sure the testui-api container has the project mounted: `- ./:/wheels-test-suite:ro`
