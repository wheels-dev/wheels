...
flowchart TD
    ...
    C --> D{Run Test Matrix}
    D --> E1[Lucee@5 + MySQL/Postgres/SQLServer/H2/Oracle]
    D --> E2[Lucee@6 + MySQL/Postgres/SQLServer/H2/Oracle]
    D --> E3[Adobe@2018 + MySQL/Postgres/SQLServer]
    D --> E4[Adobe@2021 + MySQL/Postgres/SQLServer]
    D --> E5[Adobe@2023 + MySQL/Postgres/SQLServer]
    D --> E6[Lucee@7 + All DBs - Experimental]
    D --> E7[Adobe@2025 + MySQL/Postgres/SQLServer - Experimental]
