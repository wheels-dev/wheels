...
| Browser testing | ~~absent~~ | `BrowserTest` base class + ~60-method fluent DSL wrapping Playwright Java; `wheels browser:install` | **New** ([#2113](https://github.com/wheels-dev/wheels/pull/2113), [#2115](https://github.com/wheels-dev/wheels/pull/2115), [#2116](https://github.com/wheels-dev/wheels/pull/2116), [#2121](https://github.com/wheels-dev/wheels/pull/2121)) |
