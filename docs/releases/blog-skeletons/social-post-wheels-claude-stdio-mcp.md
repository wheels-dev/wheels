...
- **The tool catalog** — `wheels_generate`, `wheels_migrate`, `wheels_test`, `wheels_destroy`, `wheels_seed`, `wheels_db`, `wheels_routes`, `wheels_info`, `wheels_analyze`, `wheels_validate`, `wheels_doctor`, `wheels_stats`, `wheels_notes`, `wheels_upgrade`, `wheels_create`, `wheels_deploy`, `wheels_reload`. Most read-only or strictly additive; `destroy` is the one you'll think twice about.
