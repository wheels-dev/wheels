...
Don't forget to check the chapter [Displaying Links for Pagination](https://guides.wheels.dev/2.5.0/v/3.0.0-snapshot/displaying-views-to-users/displaying-links-for-pagination).
